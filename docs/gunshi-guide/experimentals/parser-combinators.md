[Skip to content](https://gunshi.dev/guide/experimentals/parser-combinators#VPContent)
...
On this page
  * [Import Paths](https://gunshi.dev/guide/experimentals/parser-combinators#import-paths "Import Paths")
  * [Traditional vs Combinator Approach](https://gunshi.dev/guide/experimentals/parser-combinators#traditional-vs-combinator-approach "Traditional vs Combinator Approach")
  * [Base Combinators](https://gunshi.dev/guide/experimentals/parser-combinators#base-combinators "Base Combinators")
  * [Modifier Combinators](https://gunshi.dev/guide/experimentals/parser-combinators#modifier-combinators "Modifier Combinators")
  * [Schema Composition](https://gunshi.dev/guide/experimentals/parser-combinators#schema-composition "Schema Composition")
  * [Complete Example](https://gunshi.dev/guide/experimentals/parser-combinators#complete-example "Complete Example")
  * [Type Inference](https://gunshi.dev/guide/experimentals/parser-combinators#type-inference "Type Inference")
  * [Guidelines](https://gunshi.dev/guide/experimentals/parser-combinators#guidelines "Guidelines")
  * [Migration from Traditional Approach](https://gunshi.dev/guide/experimentals/parser-combinators#migration-from-traditional-approach "Migration from Traditional Approach")


Are you an LLM? You can read better optimized documentation at /guide/experimentals/parser-combinators.md for this page in Markdown format
# Parser Combinators [​](https://gunshi.dev/guide/experimentals/parser-combinators#parser-combinators)
WARNING
...
## Import Paths [​](https://gunshi.dev/guide/experimentals/parser-combinators#import-paths)
...
## Traditional vs Combinator Approach [​](https://gunshi.dev/guide/experimentals/parser-combinators#traditional-vs-combinator-approach)
Let's compare the traditional object-based approach with parser combinators to understand the difference:
### Traditional Approach [​](https://gunshi.dev/guide/experimentals/parser-combinators#traditional-approach)
traditional.ts
ts```
...
### Combinator Approach [​](https://gunshi.dev/guide/experimentals/parser-combinators#combinator-approach)
combinators.ts
ts```
import { define } from 'gunshi'
...
## Base Combinators [​](https://gunshi.dev/guide/experimentals/parser-combinators#base-combinators)
...
### string() [​](https://gunshi.dev/guide/experimentals/parser-combinators#string)
...
### number() [​](https://gunshi.dev/guide/experimentals/parser-combinators#number)
...
### integer() [​](https://gunshi.dev/guide/experimentals/parser-combinators#integer)
...
### float() [​](https://gunshi.dev/guide/experimentals/parser-combinators#float)
...
### boolean() [​](https://gunshi.dev/guide/experimentals/parser-combinators#boolean)
...
### choice() [​](https://gunshi.dev/guide/experimentals/parser-combinators#choice)
...
### positional() [​](https://gunshi.dev/guide/experimentals/parser-combinators#positional)
Creates a positional argument that can optionally use a parser:
positional-example.ts
ts```
import { define } from 'gunshi'
...
### combinator() [​](https://gunshi.dev/guide/experimentals/parser-combinators#combinator)
Creates custom parsers for specialized types:
custom-combinator.ts
ts```
import { define } from 'gunshi'
...
## Modifier Combinators [​](https://gunshi.dev/guide/experimentals/parser-combinators#modifier-combinators)
Modifier combinators wrap base combinators to change their behavior or add constraints.
### required() [​](https://gunshi.dev/guide/experimentals/parser-combinators#required)
...
### unrequired() [​](https://gunshi.dev/guide/experimentals/parser-combinators#unrequired)
...
### withDefault() [​](https://gunshi.dev/guide/experimentals/parser-combinators#withdefault)
...
### short() [​](https://gunshi.dev/guide/experimentals/parser-combinators#short)
...
### describe() [​](https://gunshi.dev/guide/experimentals/parser-combinators#describe)
...
### multiple() [​](https://gunshi.dev/guide/experimentals/parser-combinators#multiple)
...
### map() [​](https://gunshi.dev/guide/experimentals/parser-combinators#map)
...
## Schema Composition [​](https://gunshi.dev/guide/experimentals/parser-combinators#schema-composition)
Schema composition combinators help you build reusable and maintainable argument configurations.
### args() [​](https://gunshi.dev/guide/experimentals/parser-combinators#args)
...
### merge() [​](https://gunshi.dev/guide/experimentals/parser-combinators#merge)
...
### extend() [​](https://gunshi.dev/guide/experimentals/parser-combinators#extend)
...
## Complete Example [​](https://gunshi.dev/guide/experimentals/parser-combinators#complete-example)
...
## Type Inference [​](https://gunshi.dev/guide/experimentals/parser-combinators#type-inference)
...
## Guidelines [​](https://gunshi.dev/guide/experimentals/parser-combinators#guidelines)
...
## Migration from Traditional Approach [​](https://gunshi.dev/guide/experimentals/parser-combinators#migration-from-traditional-approach)
...
Pager
[Previous pageNested Sub-Commands](https://gunshi.dev/guide/advanced/nested-sub-commands)
[Next pagePlugin System Introduction](https://gunshi.dev/guide/plugin/introduction)
