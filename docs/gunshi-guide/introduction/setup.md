[Skip to content](https://gunshi.dev/guide/introduction/setup#VPContent)
...
On this page
  * [Install](https://gunshi.dev/guide/introduction/setup#install "Install")
  * [LLM-Assisted Development](https://gunshi.dev/guide/introduction/setup#llm-assisted-development "LLM-Assisted Development")
  * [Requirements](https://gunshi.dev/guide/introduction/setup#requirements "Requirements")


Are you an LLM? You can read better optimized documentation at /guide/introduction/setup.md for this page in Markdown format
# Setup [​](https://gunshi.dev/guide/introduction/setup#setup)
...
## Install [​](https://gunshi.dev/guide/introduction/setup#install)
### Stable [​](https://gunshi.dev/guide/introduction/setup#stable)
npmpnpmyarndenobun
sh```
...
## LLM-Assisted Development [​](https://gunshi.dev/guide/introduction/setup#llm-assisted-development)
Gunshi provides tooling to integrate with AI coding assistants such as [Claude Code](https://claude.ai/code).
### Automatic Setup (Recommended) [​](https://gunshi.dev/guide/introduction/setup#automatic-setup-recommended)
...
### Manual Setup [​](https://gunshi.dev/guide/introduction/setup#manual-setup)
...
## Requirements [​](https://gunshi.dev/guide/introduction/setup#requirements)
Gunshi requires:
  * **JavaScript Runtime** : 
...
Pager
[Previous pageWhat's Gunshi?](https://gunshi.dev/guide/introduction/what-is-gunshi)
[Next pageGetting Started](https://gunshi.dev/guide/essentials/getting-started)
