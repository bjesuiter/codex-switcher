[Skip to content](https://gunshi.dev/api/plugin/variables/CLI_OPTIONS_DEFAULT#VPContent)
...
Are you an LLM? You can read better optimized documentation at /api/plugin/variables/CLI_OPTIONS_DEFAULT.md for this page in Markdown format
[gunshi](https://gunshi.dev/api/) / [plugin](https://gunshi.dev/api/plugin/) / CLI_OPTIONS_DEFAULT
# Variable: CLI_OPTIONS_DEFAULT [​](https://gunshi.dev/api/plugin/variables/CLI_OPTIONS_DEFAULT#variable-cli-options-default)
ts```
const CLI_OPTIONS_DEFAULT: CliOptions<DefaultGunshiParams>;
```

Pager
[Previous pageplugin](https://gunshi.dev/api/plugin/)
[Next pagerenderer](https://gunshi.dev/api/renderer/)
