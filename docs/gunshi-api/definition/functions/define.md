[Skip to content](https://gunshi.dev/api/definition/functions/define#VPContent)
...
On this page
  * [Type Parameters](https://gunshi.dev/api/definition/functions/define#type-parameters "Type Parameters")
  * [Parameters](https://gunshi.dev/api/definition/functions/define#parameters "Parameters")
  * [Returns](https://gunshi.dev/api/definition/functions/define#returns "Returns")
  * [Example](https://gunshi.dev/api/definition/functions/define#example "Example")


Are you an LLM? You can read better optimized documentation at /api/definition/functions/define.md for this page in Markdown format
[gunshi](https://gunshi.dev/api/) / [definition](https://gunshi.dev/api/definition/) / define
# Function: define() [​](https://gunshi.dev/api/definition/functions/define#function-define)
ts```
...
Define a [command](https://gunshi.dev/api/default/interfaces/Command).
## Type Parameters [​](https://gunshi.dev/api/definition/functions/define#type-parameters)
Type Parameter | Default type | Description  
---|---|---  
`G` _extends_ [`GunshiParamsConstraint`](https://gunshi.dev/api/default/type-aliases/GunshiParamsConstraint) | [`DefaultGunshiParams`](https://gunshi.dev/api/default/type-aliases/DefaultGunshiParams) | A [GunshiParamsConstraint](https://gunshi.dev/api/default/type-aliases/GunshiParamsConstraint) type  
`A` _extends_ [`Args`](https://gunshi.dev/api/default/interfaces/Args) |  `ExtractArgs`<`G`> | An [Args](https://gunshi.dev/api/default/interfaces/Args) type extracted from [GunshiParamsConstraint](https://gunshi.dev/api/default/type-aliases/GunshiParamsConstraint)  
`C` _extends_ `InferCommandProps`<`G`> |  `InferCommandProps`<`G`> | A [Command](https://gunshi.dev/api/default/interfaces/Command) type inferred from [GunshiParamsConstraint](https://gunshi.dev/api/default/type-aliases/GunshiParamsConstraint)  
## Parameters [​](https://gunshi.dev/api/definition/functions/define#parameters)
Parameter | Type | Description  
---|---|---  
`definition` |  `C` & [`Command`](https://gunshi.dev/api/default/interfaces/Command)<{ `args`: `A`; `extensions`: `ExtractExtensions`<`G`>; }> | A [command](https://gunshi.dev/api/default/interfaces/Command) definition  
## Returns [​](https://gunshi.dev/api/definition/functions/define#returns)
{ [K in string | number | symbol]: (Pick<C, keyof C> & Partial<Pick<Command<G>, Exclude<"name", keyof C> | Exclude<"description", keyof C> | Exclude<"subCommands", keyof C> | Exclude<"run", keyof C> | Exclude<"args", keyof C> | Exclude<"examples", keyof C> | Exclude<"toKebab", keyof C> | Exclude<"internal", keyof C> | Exclude<"entry", keyof C> | Exclude<"rendering", keyof C>>>)[K] }
A defined [command](https://gunshi.dev/api/default/interfaces/Command)
## Example [​](https://gunshi.dev/api/definition/functions/define#example)
ts```
...
Pager
[Previous pagedefinition](https://gunshi.dev/api/definition/)
[Next pagedefineWithTypes](https://gunshi.dev/api/definition/functions/defineWithTypes)
