[Skip to content](https://gunshi.dev/api/definition/functions/lazy#VPContent)
...
On this page
  * [Param](https://gunshi.dev/api/definition/functions/lazy#param "Param")
  * [Param](https://gunshi.dev/api/definition/functions/lazy#param-1 "Param")
  * [Call Signature](https://gunshi.dev/api/definition/functions/lazy#call-signature "Call Signature")
  * [Call Signature](https://gunshi.dev/api/definition/functions/lazy#call-signature-1 "Call Signature")


Are you an LLM? You can read better optimized documentation at /api/definition/functions/lazy.md for this page in Markdown format
[gunshi](https://gunshi.dev/api/) / [definition](https://gunshi.dev/api/definition/) / lazy
# Function: lazy() [​](https://gunshi.dev/api/definition/functions/lazy#function-lazy)
Define a [lazy command](https://gunshi.dev/api/default/type-aliases/LazyCommand) with or without definition.
## Param [​](https://gunshi.dev/api/definition/functions/lazy#param)
A [command loader](https://gunshi.dev/api/default/type-aliases/CommandLoader) function that returns a command definition
## Param [​](https://gunshi.dev/api/definition/functions/lazy#param-1)
An optional [command](https://gunshi.dev/api/default/interfaces/Command) definition
## Call Signature [​](https://gunshi.dev/api/definition/functions/lazy#call-signature)
ts```
...
Define a [lazy command](https://gunshi.dev/api/default/type-aliases/LazyCommand).
### Type Parameters [​](https://gunshi.dev/api/definition/functions/lazy#type-parameters)
Type Parameter | Description  
---|---  
`A` _extends_ [`Args`](https://gunshi.dev/api/default/interfaces/Args) | An [Args](https://gunshi.dev/api/default/interfaces/Args) type  
### Parameters [​](https://gunshi.dev/api/definition/functions/lazy#parameters)
Parameter | Type | Description  
---|---|---  
`loader` |  [`CommandLoader`](https://gunshi.dev/api/default/type-aliases/CommandLoader)<{ `args`: `A`; `extensions`: { }; }> | A [command loader](https://gunshi.dev/api/default/type-aliases/CommandLoader)  
### Returns [​](https://gunshi.dev/api/definition/functions/lazy#returns)
[`LazyCommand`](https://gunshi.dev/api/default/type-aliases/LazyCommand)<{ `args`: `A`; `extensions`: { }; }, { }>
A [lazy command](https://gunshi.dev/api/default/type-aliases/LazyCommand) with loader
### Example [​](https://gunshi.dev/api/definition/functions/lazy#example)
ts```
// load command with dynamic importing
const test = lazy(() => import('./commands/test'))
```

## Call Signature [​](https://gunshi.dev/api/definition/functions/lazy#call-signature-1)
ts```
...
Define a [lazy command](https://gunshi.dev/api/default/type-aliases/LazyCommand) with definition.
### Type Parameters [​](https://gunshi.dev/api/definition/functions/lazy#type-parameters-1)
Type Parameter | Default type | Description  
---|---|---  
`G` _extends_ [`GunshiParamsConstraint`](https://gunshi.dev/api/default/type-aliases/GunshiParamsConstraint) | [`DefaultGunshiParams`](https://gunshi.dev/api/default/type-aliases/DefaultGunshiParams) | -  
`A` _extends_ [`Args`](https://gunshi.dev/api/default/interfaces/Args) |  `ExtractArgs`<`G`> | An [Args](https://gunshi.dev/api/default/interfaces/Args) type  
`D` _extends_ `Partial`<[`Command`](https://gunshi.dev/api/default/interfaces/Command)<{ `args`: `A`; `extensions`: { }; }>> |  `Partial`<[`Command`](https://gunshi.dev/api/default/interfaces/Command)<{ `args`: `A`; `extensions`: { }; }>> | A partial [Command](https://gunshi.dev/api/default/interfaces/Command) definition type  
### Parameters [​](https://gunshi.dev/api/definition/functions/lazy#parameters-1)
Parameter | Type | Description  
---|---|---  
`loader` |  [`CommandLoader`](https://gunshi.dev/api/default/type-aliases/CommandLoader)<{ `args`: `A`; `extensions`: { }; }> | A [command loader](https://gunshi.dev/api/default/type-aliases/CommandLoader) function that returns a command definition  
`definition` | `D` | An optional [command](https://gunshi.dev/api/default/interfaces/Command) definition  
### Returns [​](https://gunshi.dev/api/definition/functions/lazy#returns-1)
[`LazyCommand`](https://gunshi.dev/api/default/type-aliases/LazyCommand)<{ `args`: `A`; `extensions`: { }; }, `D`>
A [lazy command](https://gunshi.dev/api/default/type-aliases/LazyCommand) that can be executed later
### Example [​](https://gunshi.dev/api/definition/functions/lazy#example-1)
ts```
...
Pager
[Previous pagedefineWithTypes](https://gunshi.dev/api/definition/functions/defineWithTypes)
[Next pagelazyWithTypes](https://gunshi.dev/api/definition/functions/lazyWithTypes)
