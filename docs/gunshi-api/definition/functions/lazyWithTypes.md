[Skip to content](https://gunshi.dev/api/definition/functions/lazyWithTypes#VPContent)
...
On this page
  * [Type Parameters](https://gunshi.dev/api/definition/functions/lazyWithTypes#type-parameters "Type Parameters")
  * [Returns](https://gunshi.dev/api/definition/functions/lazyWithTypes#returns "Returns")
  * [Example](https://gunshi.dev/api/definition/functions/lazyWithTypes#example "Example")
  * [Since](https://gunshi.dev/api/definition/functions/lazyWithTypes#since "Since")


Are you an LLM? You can read better optimized documentation at /api/definition/functions/lazyWithTypes.md for this page in Markdown format
[gunshi](https://gunshi.dev/api/) / [definition](https://gunshi.dev/api/definition/) / lazyWithTypes
# Function: lazyWithTypes() [​](https://gunshi.dev/api/definition/functions/lazyWithTypes#function-lazywithtypes)
ts```
function lazyWithTypes<G>(): LazyWithTypesReturn<NormalizeGunshiParams<G>>;
```

Define a [lazy command](https://gunshi.dev/api/default/type-aliases/LazyCommand) with specific type parameters.
This helper function allows specifying the type parameter of [GunshiParams](https://gunshi.dev/api/default/interfaces/GunshiParams) while inferring the [Args](https://gunshi.dev/api/default/interfaces/Args) type, [ExtendContext](https://gunshi.dev/api/default/type-aliases/ExtendContext) type from the definition.
## Type Parameters [​](https://gunshi.dev/api/definition/functions/lazyWithTypes#type-parameters)
Type Parameter | Description  
---|---  
`G` _extends_ [`GunshiParamsConstraint`](https://gunshi.dev/api/default/type-aliases/GunshiParamsConstraint) | A [GunshiParams](https://gunshi.dev/api/default/interfaces/GunshiParams) type  
## Returns [​](https://gunshi.dev/api/definition/functions/lazyWithTypes#returns)
`LazyWithTypesReturn`<`NormalizeGunshiParams`<`G`>>
A function that takes a lazy command definition via [lazy](https://gunshi.dev/api/definition/functions/lazy)
## Example [​](https://gunshi.dev/api/definition/functions/lazyWithTypes#example)
ts```
...
## Since [​](https://gunshi.dev/api/definition/functions/lazyWithTypes#since)
v0.27.0
Pager
[Previous pagelazy](https://gunshi.dev/api/definition/functions/lazy)
[Next pagegenerator](https://gunshi.dev/api/generator/)
