[Skip to content](https://gunshi.dev/api/definition/functions/defineWithTypes#VPContent)
...
On this page
  * [Type Parameters](https://gunshi.dev/api/definition/functions/defineWithTypes#type-parameters "Type Parameters")
  * [Returns](https://gunshi.dev/api/definition/functions/defineWithTypes#returns "Returns")
  * [Example](https://gunshi.dev/api/definition/functions/defineWithTypes#example "Example")
  * [Since](https://gunshi.dev/api/definition/functions/defineWithTypes#since "Since")


Are you an LLM? You can read better optimized documentation at /api/definition/functions/defineWithTypes.md for this page in Markdown format
[gunshi](https://gunshi.dev/api/) / [definition](https://gunshi.dev/api/definition/) / defineWithTypes
# Function: defineWithTypes() [​](https://gunshi.dev/api/definition/functions/defineWithTypes#function-definewithtypes)
ts```
function defineWithTypes<G>(): DefineWithTypesReturn<ExtractExtensions<G>, ExtractArgs<G>>;
```

Define a [command](https://gunshi.dev/api/default/interfaces/Command) with types
...
## Type Parameters [​](https://gunshi.dev/api/definition/functions/defineWithTypes#type-parameters)
...
## Returns [​](https://gunshi.dev/api/definition/functions/defineWithTypes#returns)
`DefineWithTypesReturn`<`ExtractExtensions`<`G`>, `ExtractArgs`<`G`>>
A function that takes a command definition via [define](https://gunshi.dev/api/definition/functions/define)
## Example [​](https://gunshi.dev/api/definition/functions/defineWithTypes#example)
ts```
...
## Since [​](https://gunshi.dev/api/definition/functions/defineWithTypes#since)
v0.27.0
Pager
[Previous pagedefine](https://gunshi.dev/api/definition/functions/define)
[Next pagelazy](https://gunshi.dev/api/definition/functions/lazy)
