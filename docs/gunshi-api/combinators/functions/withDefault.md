[Skip to content](https://gunshi.dev/api/combinators/functions/withDefault#VPContent)
...
On this page
  * [Type Parameters](https://gunshi.dev/api/combinators/functions/withDefault#type-parameters "Type Parameters")
  * [Parameters](https://gunshi.dev/api/combinators/functions/withDefault#parameters "Parameters")
  * [Returns](https://gunshi.dev/api/combinators/functions/withDefault#returns "Returns")
  * [Example](https://gunshi.dev/api/combinators/functions/withDefault#example "Example")


Are you an LLM? You can read better optimized documentation at /api/combinators/functions/withDefault.md for this page in Markdown format
[gunshi](https://gunshi.dev/api/) / [combinators](https://gunshi.dev/api/combinators/) / withDefault
# Function: withDefault() [​](https://gunshi.dev/api/combinators/functions/withDefault#function-withdefault)
ts```
...
## Type Parameters [​](https://gunshi.dev/api/combinators/functions/withDefault#type-parameters)
Type Parameter | Description  
---|---  
`T` _extends_ `string` | `number` | `boolean` | The schema's parsed type.  
## Parameters [​](https://gunshi.dev/api/combinators/functions/withDefault#parameters)
Parameter | Type | Description  
---|---|---  
`schema` |  [`CombinatorSchema`](https://gunshi.dev/api/combinators/type-aliases/CombinatorSchema)<`T`> | The base combinator schema.  
`defaultValue` | `T` | The default value.  
## Returns [​](https://gunshi.dev/api/combinators/functions/withDefault#returns)
[`ArgSchema`](https://gunshi.dev/api/default/interfaces/ArgSchema) & [`Combinator`](https://gunshi.dev/api/combinators/type-aliases/Combinator)<`T`> & `CombinatorWithDefault`<`T`>
A new schema with the default value set.
## Example [​](https://gunshi.dev/api/combinators/functions/withDefault#example)
ts```
const args = {
...
Pager
[Previous pageunrequired](https://gunshi.dev/api/combinators/functions/unrequired)
[Next pageBaseOptions](https://gunshi.dev/api/combinators/interfaces/BaseOptions)
