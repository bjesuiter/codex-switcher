[Skip to content](https://gunshi.dev/api/combinators/functions/integer#VPContent)
...
On this page
  * [Parameters](https://gunshi.dev/api/combinators/functions/integer#parameters "Parameters")
  * [Returns](https://gunshi.dev/api/combinators/functions/integer#returns "Returns")
  * [Example](https://gunshi.dev/api/combinators/functions/integer#example "Example")


Are you an LLM? You can read better optimized documentation at /api/combinators/functions/integer.md for this page in Markdown format
[gunshi](https://gunshi.dev/api/) / [combinators](https://gunshi.dev/api/combinators/) / integer
# Function: integer() [​](https://gunshi.dev/api/combinators/functions/integer#function-integer)
ts```
...
## Parameters [​](https://gunshi.dev/api/combinators/functions/integer#parameters)
Parameter | Type | Description  
---|---|---  
`opts?` | [`IntegerOptions`](https://gunshi.dev/api/combinators/interfaces/IntegerOptions) | Range options.  
## Returns [​](https://gunshi.dev/api/combinators/functions/integer#returns)
...
## Example [​](https://gunshi.dev/api/combinators/functions/integer#example)
ts```
const args = {
...
Pager
[Previous pagefloat](https://gunshi.dev/api/combinators/functions/float)
[Next pagemap](https://gunshi.dev/api/combinators/functions/map)
