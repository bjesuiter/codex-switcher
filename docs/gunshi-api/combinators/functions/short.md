[Skip to content](https://gunshi.dev/api/combinators/functions/short#VPContent)
...
On this page
  * [Type Parameters](https://gunshi.dev/api/combinators/functions/short#type-parameters "Type Parameters")
  * [Parameters](https://gunshi.dev/api/combinators/functions/short#parameters "Parameters")
  * [Returns](https://gunshi.dev/api/combinators/functions/short#returns "Returns")
  * [Example](https://gunshi.dev/api/combinators/functions/short#example "Example")


Are you an LLM? You can read better optimized documentation at /api/combinators/functions/short.md for this page in Markdown format
[gunshi](https://gunshi.dev/api/) / [combinators](https://gunshi.dev/api/combinators/) / short
# Function: short() [​](https://gunshi.dev/api/combinators/functions/short#function-short)
ts```
...
## Type Parameters [​](https://gunshi.dev/api/combinators/functions/short#type-parameters)
Type Parameter | Description  
---|---  
`T` | The schema's parsed type.  
`S` _extends_ `string` | The short alias string literal type.  
## Parameters [​](https://gunshi.dev/api/combinators/functions/short#parameters)
...
## Returns [​](https://gunshi.dev/api/combinators/functions/short#returns)
[`ArgSchema`](https://gunshi.dev/api/default/interfaces/ArgSchema) & [`Combinator`](https://gunshi.dev/api/combinators/type-aliases/Combinator)<`T`> & `CombinatorShort`<`S`>
A new schema with the short alias set.
## Example [​](https://gunshi.dev/api/combinators/functions/short#example)
ts```
const args = {
...
Pager
[Previous pagerequired](https://gunshi.dev/api/combinators/functions/required)
[Next pagestring](https://gunshi.dev/api/combinators/functions/string)
