[Skip to content](https://gunshi.dev/api/combinators/functions/unrequired#VPContent)
...
On this page
  * [Type Parameters](https://gunshi.dev/api/combinators/functions/unrequired#type-parameters "Type Parameters")
  * [Parameters](https://gunshi.dev/api/combinators/functions/unrequired#parameters "Parameters")
  * [Returns](https://gunshi.dev/api/combinators/functions/unrequired#returns "Returns")
  * [Example](https://gunshi.dev/api/combinators/functions/unrequired#example "Example")


Are you an LLM? You can read better optimized documentation at /api/combinators/functions/unrequired.md for this page in Markdown format
[gunshi](https://gunshi.dev/api/) / [combinators](https://gunshi.dev/api/combinators/) / unrequired
# Function: unrequired() [​](https://gunshi.dev/api/combinators/functions/unrequired#function-unrequired)
ts```
...
## Type Parameters [​](https://gunshi.dev/api/combinators/functions/unrequired#type-parameters)
Type Parameter | Description  
---|---  
`T` | The schema's parsed type.  
## Parameters [​](https://gunshi.dev/api/combinators/functions/unrequired#parameters)
Parameter | Type | Description  
---|---|---  
`schema` |  [`CombinatorSchema`](https://gunshi.dev/api/combinators/type-aliases/CombinatorSchema)<`T`> | The base combinator schema.  
## Returns [​](https://gunshi.dev/api/combinators/functions/unrequired#returns)
[`ArgSchema`](https://gunshi.dev/api/default/interfaces/ArgSchema) & [`Combinator`](https://gunshi.dev/api/combinators/type-aliases/Combinator)<`T`> & `CombinatorUnrequired`
A new schema with `required: false`.
## Example [​](https://gunshi.dev/api/combinators/functions/unrequired#example)
ts```
const args = {
...
Pager
[Previous pagestring](https://gunshi.dev/api/combinators/functions/string)
[Next pagewithDefault](https://gunshi.dev/api/combinators/functions/withDefault)
