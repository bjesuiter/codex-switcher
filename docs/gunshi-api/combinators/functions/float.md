[Skip to content](https://gunshi.dev/api/combinators/functions/float#VPContent)
...
On this page
  * [Parameters](https://gunshi.dev/api/combinators/functions/float#parameters "Parameters")
  * [Returns](https://gunshi.dev/api/combinators/functions/float#returns "Returns")
  * [Example](https://gunshi.dev/api/combinators/functions/float#example "Example")


Are you an LLM? You can read better optimized documentation at /api/combinators/functions/float.md for this page in Markdown format
[gunshi](https://gunshi.dev/api/) / [combinators](https://gunshi.dev/api/combinators/) / float
# Function: float() [​](https://gunshi.dev/api/combinators/functions/float#function-float)
ts```
...
## Parameters [​](https://gunshi.dev/api/combinators/functions/float#parameters)
Parameter | Type | Description  
---|---|---  
`opts?` | [`FloatOptions`](https://gunshi.dev/api/combinators/interfaces/FloatOptions) | Range options.  
## Returns [​](https://gunshi.dev/api/combinators/functions/float#returns)
...
## Example [​](https://gunshi.dev/api/combinators/functions/float#example)
ts```
const args = {
...
Pager
[Previous pageextend](https://gunshi.dev/api/combinators/functions/extend)
[Next pageinteger](https://gunshi.dev/api/combinators/functions/integer)
