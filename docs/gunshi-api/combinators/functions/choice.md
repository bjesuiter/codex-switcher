[Skip to content](https://gunshi.dev/api/combinators/functions/choice#VPContent)
...
On this page
  * [Type Parameters](https://gunshi.dev/api/combinators/functions/choice#type-parameters "Type Parameters")
  * [Parameters](https://gunshi.dev/api/combinators/functions/choice#parameters "Parameters")
  * [Returns](https://gunshi.dev/api/combinators/functions/choice#returns "Returns")
  * [Example](https://gunshi.dev/api/combinators/functions/choice#example "Example")


Are you an LLM? You can read better optimized documentation at /api/combinators/functions/choice.md for this page in Markdown format
[gunshi](https://gunshi.dev/api/) / [combinators](https://gunshi.dev/api/combinators/) / choice
# Function: choice() [​](https://gunshi.dev/api/combinators/functions/choice#function-choice)
ts```
...
## Type Parameters [​](https://gunshi.dev/api/combinators/functions/choice#type-parameters)
Type Parameter | Description  
---|---  
`T` _extends_ readonly `string`[] | The readonly array of allowed string values.  
## Parameters [​](https://gunshi.dev/api/combinators/functions/choice#parameters)
Parameter | Type | Description  
---|---|---  
`values` | `T` | Allowed values.  
`opts?` | [`BaseOptions`](https://gunshi.dev/api/combinators/interfaces/BaseOptions) | Common options (description, short, required).  
## Returns [​](https://gunshi.dev/api/combinators/functions/choice#returns)
[`CombinatorSchema`](https://gunshi.dev/api/combinators/type-aliases/CombinatorSchema)<`T`[`number`]>
A combinator schema that resolves to a union of the allowed values.
## Example [​](https://gunshi.dev/api/combinators/functions/choice#example)
ts```
const args = {
...
Pager
[Previous pageboolean](https://gunshi.dev/api/combinators/functions/boolean)
[Next pagecombinator](https://gunshi.dev/api/combinators/functions/combinator)
