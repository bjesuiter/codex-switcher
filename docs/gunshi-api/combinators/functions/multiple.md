[Skip to content](https://gunshi.dev/api/combinators/functions/multiple#VPContent)
...
On this page
  * [Type Parameters](https://gunshi.dev/api/combinators/functions/multiple#type-parameters "Type Parameters")
  * [Parameters](https://gunshi.dev/api/combinators/functions/multiple#parameters "Parameters")
  * [Returns](https://gunshi.dev/api/combinators/functions/multiple#returns "Returns")
  * [Example](https://gunshi.dev/api/combinators/functions/multiple#example "Example")


Are you an LLM? You can read better optimized documentation at /api/combinators/functions/multiple.md for this page in Markdown format
[gunshi](https://gunshi.dev/api/) / [combinators](https://gunshi.dev/api/combinators/) / multiple
# Function: multiple() [​](https://gunshi.dev/api/combinators/functions/multiple#function-multiple)
ts```
...
## Type Parameters [​](https://gunshi.dev/api/combinators/functions/multiple#type-parameters)
Type Parameter | Description  
---|---  
`T` | The schema's parsed type.  
## Parameters [​](https://gunshi.dev/api/combinators/functions/multiple#parameters)
Parameter | Type | Description  
---|---|---  
`schema` |  [`CombinatorSchema`](https://gunshi.dev/api/combinators/type-aliases/CombinatorSchema)<`T`> | The base combinator schema.  
## Returns [​](https://gunshi.dev/api/combinators/functions/multiple#returns)
[`ArgSchema`](https://gunshi.dev/api/default/interfaces/ArgSchema) & [`Combinator`](https://gunshi.dev/api/combinators/type-aliases/Combinator)<`T`> & `CombinatorMultiple`
A new schema with `multiple: true`.
## Example [​](https://gunshi.dev/api/combinators/functions/multiple#example)
ts```
const args = {
...
Pager
[Previous pagemerge](https://gunshi.dev/api/combinators/functions/merge)
[Next pagenumber](https://gunshi.dev/api/combinators/functions/number)
