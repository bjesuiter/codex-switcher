[Skip to content](https://gunshi.dev/api/combinators/functions/extend#VPContent)
...
On this page
  * [Type Parameters](https://gunshi.dev/api/combinators/functions/extend#type-parameters "Type Parameters")
  * [Parameters](https://gunshi.dev/api/combinators/functions/extend#parameters "Parameters")
  * [Returns](https://gunshi.dev/api/combinators/functions/extend#returns "Returns")
  * [Example](https://gunshi.dev/api/combinators/functions/extend#example "Example")


Are you an LLM? You can read better optimized documentation at /api/combinators/functions/extend.md for this page in Markdown format
[gunshi](https://gunshi.dev/api/) / [combinators](https://gunshi.dev/api/combinators/) / extend
# Function: extend() [​](https://gunshi.dev/api/combinators/functions/extend#function-extend)
ts```
...
## Type Parameters [​](https://gunshi.dev/api/combinators/functions/extend#type-parameters)
Type Parameter | Description  
---|---  
`T` _extends_ [`Args`](https://gunshi.dev/api/default/interfaces/Args) | Base schema type.  
`U` _extends_ [`Args`](https://gunshi.dev/api/default/interfaces/Args) | Overrides schema type.  
## Parameters [​](https://gunshi.dev/api/combinators/functions/extend#parameters)
Parameter | Type | Description  
---|---|---  
`base` | `T` | The base schema to extend.  
`overrides` | `U` | Fields to override or add.  
## Returns [​](https://gunshi.dev/api/combinators/functions/extend#returns)
`Omit`<`T`, keyof `U`> & `U`
A new schema with overrides applied.
## Example [​](https://gunshi.dev/api/combinators/functions/extend#example)
ts```
...
Pager
[Previous pagedescribe](https://gunshi.dev/api/combinators/functions/describe)
[Next pagefloat](https://gunshi.dev/api/combinators/functions/float)
