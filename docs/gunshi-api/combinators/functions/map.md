[Skip to content](https://gunshi.dev/api/combinators/functions/map#VPContent)
...
On this page
  * [Type Parameters](https://gunshi.dev/api/combinators/functions/map#type-parameters "Type Parameters")
  * [Parameters](https://gunshi.dev/api/combinators/functions/map#parameters "Parameters")
  * [Returns](https://gunshi.dev/api/combinators/functions/map#returns "Returns")
  * [Example](https://gunshi.dev/api/combinators/functions/map#example "Example")


Are you an LLM? You can read better optimized documentation at /api/combinators/functions/map.md for this page in Markdown format
[gunshi](https://gunshi.dev/api/) / [combinators](https://gunshi.dev/api/combinators/) / map
# Function: map() [​](https://gunshi.dev/api/combinators/functions/map#function-map)
ts```
...
## Type Parameters [​](https://gunshi.dev/api/combinators/functions/map#type-parameters)
Type Parameter | Description  
---|---  
`T` | The input schema's parsed type.  
`U` | The transformed type.  
## Parameters [​](https://gunshi.dev/api/combinators/functions/map#parameters)
...
## Returns [​](https://gunshi.dev/api/combinators/functions/map#returns)
[`CombinatorSchema`](https://gunshi.dev/api/combinators/type-aliases/CombinatorSchema)<`U`>
A new combinator schema that resolves to the transformed type.
## Example [​](https://gunshi.dev/api/combinators/functions/map#example)
ts```
const args = {
...
Pager
[Previous pageinteger](https://gunshi.dev/api/combinators/functions/integer)
[Next pagemerge](https://gunshi.dev/api/combinators/functions/merge)
