[Skip to content](https://gunshi.dev/api/combinators/functions/positional#VPContent)
...
On this page
  * [Call Signature](https://gunshi.dev/api/combinators/functions/positional#call-signature "Call Signature")
  * [Call Signature](https://gunshi.dev/api/combinators/functions/positional#call-signature-1 "Call Signature")


Are you an LLM? You can read better optimized documentation at /api/combinators/functions/positional.md for this page in Markdown format
[gunshi](https://gunshi.dev/api/) / [combinators](https://gunshi.dev/api/combinators/) / positional
# Function: positional() [​](https://gunshi.dev/api/combinators/functions/positional#function-positional)
## Call Signature [​](https://gunshi.dev/api/combinators/functions/positional#call-signature)
ts```
...
### Type Parameters [​](https://gunshi.dev/api/combinators/functions/positional#type-parameters)
Type Parameter | Description  
---|---  
`T` | The parser's resolved type.  
### Parameters [​](https://gunshi.dev/api/combinators/functions/positional#parameters)
Parameter | Type | Description  
---|---|---  
`parser` |  [`CombinatorSchema`](https://gunshi.dev/api/combinators/type-aliases/CombinatorSchema)<`T`> | The parser combinator schema.  
### Returns [​](https://gunshi.dev/api/combinators/functions/positional#returns)
[`ArgSchema`](https://gunshi.dev/api/default/interfaces/ArgSchema) & [`Combinator`](https://gunshi.dev/api/combinators/type-aliases/Combinator)<`T`> & `ArgSchemaPositionalType`
A positional argument schema resolving to the parser's type.
### Example [​](https://gunshi.dev/api/combinators/functions/positional#example)
ts```
const args = {
...
## Call Signature [​](https://gunshi.dev/api/combinators/functions/positional#call-signature-1)
ts```
...
Create a positional argument schema.
Without a parser, resolves to string. With a parser (e.g., `positional(integer())`), resolves to the parser's return type.
### Parameters [​](https://gunshi.dev/api/combinators/functions/positional#parameters-1)
Parameter | Type | Description  
---|---|---  
`parser?` | [`BaseOptions`](https://gunshi.dev/api/combinators/interfaces/BaseOptions) | Optional base options (description, short, required).  
### Returns [​](https://gunshi.dev/api/combinators/functions/positional#returns-1)
[`ArgSchema`](https://gunshi.dev/api/default/interfaces/ArgSchema) & `ArgSchemaPositionalType`
A positional argument schema resolving to string.
### Example [​](https://gunshi.dev/api/combinators/functions/positional#example-1)
ts```
const args = {
  command: positional(),           // resolves to string
  port: positional(integer()),     // resolves to number
...
Pager
[Previous pagenumber](https://gunshi.dev/api/combinators/functions/number)
[Next pagerequired](https://gunshi.dev/api/combinators/functions/required)
