[Skip to content](https://gunshi.dev/api/combinators/functions/string#VPContent)
...
On this page
  * [Parameters](https://gunshi.dev/api/combinators/functions/string#parameters "Parameters")
  * [Returns](https://gunshi.dev/api/combinators/functions/string#returns "Returns")
  * [Example](https://gunshi.dev/api/combinators/functions/string#example "Example")


Are you an LLM? You can read better optimized documentation at /api/combinators/functions/string.md for this page in Markdown format
[gunshi](https://gunshi.dev/api/) / [combinators](https://gunshi.dev/api/combinators/) / string
# Function: string() [​](https://gunshi.dev/api/combinators/functions/string#function-string)
ts```
...
## Parameters [​](https://gunshi.dev/api/combinators/functions/string#parameters)
Parameter | Type | Description  
---|---|---  
`opts?` | [`StringOptions`](https://gunshi.dev/api/combinators/interfaces/StringOptions) | Validation options.  
## Returns [​](https://gunshi.dev/api/combinators/functions/string#returns)
[`CombinatorSchema`](https://gunshi.dev/api/combinators/type-aliases/CombinatorSchema)<`string`>
A combinator schema that resolves to string.
## Example [​](https://gunshi.dev/api/combinators/functions/string#example)
ts```
const args = {
...
Pager
[Previous pageshort](https://gunshi.dev/api/combinators/functions/short)
[Next pageunrequired](https://gunshi.dev/api/combinators/functions/unrequired)
