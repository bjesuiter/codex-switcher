[Skip to content](https://gunshi.dev/api/combinators/functions/boolean#VPContent)
...
On this page
  * [Parameters](https://gunshi.dev/api/combinators/functions/boolean#parameters "Parameters")
  * [Returns](https://gunshi.dev/api/combinators/functions/boolean#returns "Returns")
  * [Example](https://gunshi.dev/api/combinators/functions/boolean#example "Example")


Are you an LLM? You can read better optimized documentation at /api/combinators/functions/boolean.md for this page in Markdown format
[gunshi](https://gunshi.dev/api/) / [combinators](https://gunshi.dev/api/combinators/) / boolean
# Function: boolean() [​](https://gunshi.dev/api/combinators/functions/boolean#function-boolean)
ts```
...
## Parameters [​](https://gunshi.dev/api/combinators/functions/boolean#parameters)
Parameter | Type | Description  
---|---|---  
`opts?` | [`BooleanOptions`](https://gunshi.dev/api/combinators/interfaces/BooleanOptions) | Boolean options.  
## Returns [​](https://gunshi.dev/api/combinators/functions/boolean#returns)
[`CombinatorSchema`](https://gunshi.dev/api/combinators/type-aliases/CombinatorSchema)<`boolean`>
A combinator schema for boolean flags.
## Example [​](https://gunshi.dev/api/combinators/functions/boolean#example)
ts```
const args = {
...
Pager
[Previous pageargs](https://gunshi.dev/api/combinators/functions/args)
[Next pagechoice](https://gunshi.dev/api/combinators/functions/choice)
