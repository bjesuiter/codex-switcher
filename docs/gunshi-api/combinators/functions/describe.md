[Skip to content](https://gunshi.dev/api/combinators/functions/describe#VPContent)
...
On this page
  * [Type Parameters](https://gunshi.dev/api/combinators/functions/describe#type-parameters "Type Parameters")
  * [Parameters](https://gunshi.dev/api/combinators/functions/describe#parameters "Parameters")
  * [Returns](https://gunshi.dev/api/combinators/functions/describe#returns "Returns")
  * [Example](https://gunshi.dev/api/combinators/functions/describe#example "Example")


Are you an LLM? You can read better optimized documentation at /api/combinators/functions/describe.md for this page in Markdown format
[gunshi](https://gunshi.dev/api/) / [combinators](https://gunshi.dev/api/combinators/) / describe
# Function: describe() [​](https://gunshi.dev/api/combinators/functions/describe#function-describe)
ts```
...
## Type Parameters [​](https://gunshi.dev/api/combinators/functions/describe#type-parameters)
Type Parameter | Description  
---|---  
`T` | The schema's parsed type.  
`D` _extends_ `string` | The description string literal type.  
## Parameters [​](https://gunshi.dev/api/combinators/functions/describe#parameters)
...
## Returns [​](https://gunshi.dev/api/combinators/functions/describe#returns)
[`ArgSchema`](https://gunshi.dev/api/default/interfaces/ArgSchema) & [`Combinator`](https://gunshi.dev/api/combinators/type-aliases/Combinator)<`T`> & `CombinatorDescribe`<`D`>
A new schema with the description set.
## Example [​](https://gunshi.dev/api/combinators/functions/describe#example)
ts```
const args = {
...
Pager
[Previous pagecombinator](https://gunshi.dev/api/combinators/functions/combinator)
[Next pageextend](https://gunshi.dev/api/combinators/functions/extend)
