[Skip to content](https://gunshi.dev/api/combinators/functions/combinator#VPContent)
...
On this page
  * [Type Parameters](https://gunshi.dev/api/combinators/functions/combinator#type-parameters "Type Parameters")
  * [Parameters](https://gunshi.dev/api/combinators/functions/combinator#parameters "Parameters")
  * [Returns](https://gunshi.dev/api/combinators/functions/combinator#returns "Returns")
  * [Example](https://gunshi.dev/api/combinators/functions/combinator#example "Example")


Are you an LLM? You can read better optimized documentation at /api/combinators/functions/combinator.md for this page in Markdown format
[gunshi](https://gunshi.dev/api/) / [combinators](https://gunshi.dev/api/combinators/) / combinator
# Function: combinator() [​](https://gunshi.dev/api/combinators/functions/combinator#function-combinator)
ts```
...
This is the most general custom combinator. Use it when none of the built-in base combinators ([string](https://gunshi.dev/api/combinators/functions/string), [number](https://gunshi.dev/api/combinators/functions/number), [integer](https://gunshi.dev/api/combinators/functions/integer), [float](https://gunshi.dev/api/combinators/functions/float), [boolean](https://gunshi.dev/api/combinators/functions/boolean), [choice](https://gunshi.dev/api/combinators/functions/choice)) fit your needs.
The returned schema has `type: 'custom'`.
## Type Parameters [​](https://gunshi.dev/api/combinators/functions/combinator#type-parameters)
Type Parameter | Description  
---|---  
`T` | The parsed value type.  
## Parameters [​](https://gunshi.dev/api/combinators/functions/combinator#parameters)
Parameter | Type | Description  
---|---|---  
`config` |  [`CombinatorOptions`](https://gunshi.dev/api/combinators/interfaces/CombinatorOptions)<`T`> | Configuration with a parse function and optional metavar.  
## Returns [​](https://gunshi.dev/api/combinators/functions/combinator#returns)
[`CombinatorSchema`](https://gunshi.dev/api/combinators/type-aliases/CombinatorSchema)<`T`>
A combinator schema that resolves to the parse function's return type.
## Example [​](https://gunshi.dev/api/combinators/functions/combinator#example)
ts```
...
Pager
[Previous pagechoice](https://gunshi.dev/api/combinators/functions/choice)
[Next pagedescribe](https://gunshi.dev/api/combinators/functions/describe)
