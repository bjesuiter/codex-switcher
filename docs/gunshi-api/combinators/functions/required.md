[Skip to content](https://gunshi.dev/api/combinators/functions/required#VPContent)
...
On this page
  * [Type Parameters](https://gunshi.dev/api/combinators/functions/required#type-parameters "Type Parameters")
  * [Parameters](https://gunshi.dev/api/combinators/functions/required#parameters "Parameters")
  * [Returns](https://gunshi.dev/api/combinators/functions/required#returns "Returns")
  * [Example](https://gunshi.dev/api/combinators/functions/required#example "Example")


Are you an LLM? You can read better optimized documentation at /api/combinators/functions/required.md for this page in Markdown format
[gunshi](https://gunshi.dev/api/) / [combinators](https://gunshi.dev/api/combinators/) / required
# Function: required() [​](https://gunshi.dev/api/combinators/functions/required#function-required)
ts```
...
## Type Parameters [​](https://gunshi.dev/api/combinators/functions/required#type-parameters)
Type Parameter | Description  
---|---  
`T` | The schema's parsed type.  
## Parameters [​](https://gunshi.dev/api/combinators/functions/required#parameters)
Parameter | Type | Description  
---|---|---  
`schema` |  [`CombinatorSchema`](https://gunshi.dev/api/combinators/type-aliases/CombinatorSchema)<`T`> | The base combinator schema.  
## Returns [​](https://gunshi.dev/api/combinators/functions/required#returns)
[`ArgSchema`](https://gunshi.dev/api/default/interfaces/ArgSchema) & [`Combinator`](https://gunshi.dev/api/combinators/type-aliases/Combinator)<`T`> & `CombinatorRequired`
A new schema with `required: true`.
## Example [​](https://gunshi.dev/api/combinators/functions/required#example)
ts```
const args = {
...
Pager
[Previous pagepositional](https://gunshi.dev/api/combinators/functions/positional)
[Next pageshort](https://gunshi.dev/api/combinators/functions/short)
