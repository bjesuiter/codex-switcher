[Skip to content](https://gunshi.dev/api/combinators/functions/number#VPContent)
...
On this page
  * [Parameters](https://gunshi.dev/api/combinators/functions/number#parameters "Parameters")
  * [Returns](https://gunshi.dev/api/combinators/functions/number#returns "Returns")
  * [Example](https://gunshi.dev/api/combinators/functions/number#example "Example")


Are you an LLM? You can read better optimized documentation at /api/combinators/functions/number.md for this page in Markdown format
[gunshi](https://gunshi.dev/api/) / [combinators](https://gunshi.dev/api/combinators/) / number
# Function: number() [​](https://gunshi.dev/api/combinators/functions/number#function-number)
ts```
...
## Parameters [​](https://gunshi.dev/api/combinators/functions/number#parameters)
Parameter | Type | Description  
---|---|---  
`opts?` | [`NumberOptions`](https://gunshi.dev/api/combinators/interfaces/NumberOptions) | Range options.  
## Returns [​](https://gunshi.dev/api/combinators/functions/number#returns)
[`CombinatorSchema`](https://gunshi.dev/api/combinators/type-aliases/CombinatorSchema)<`number`>
A combinator schema that resolves to number.
## Example [​](https://gunshi.dev/api/combinators/functions/number#example)
ts```
const args = {
...
Pager
[Previous pagemultiple](https://gunshi.dev/api/combinators/functions/multiple)
[Next pagepositional](https://gunshi.dev/api/combinators/functions/positional)
