[Skip to content](https://gunshi.dev/api/combinators/functions/args#VPContent)
...
On this page
  * [Type Parameters](https://gunshi.dev/api/combinators/functions/args#type-parameters "Type Parameters")
  * [Parameters](https://gunshi.dev/api/combinators/functions/args#parameters "Parameters")
  * [Returns](https://gunshi.dev/api/combinators/functions/args#returns "Returns")
  * [Example](https://gunshi.dev/api/combinators/functions/args#example "Example")


Are you an LLM? You can read better optimized documentation at /api/combinators/functions/args.md for this page in Markdown format
[gunshi](https://gunshi.dev/api/) / [combinators](https://gunshi.dev/api/combinators/) / args
# Function: args() [​](https://gunshi.dev/api/combinators/functions/args#function-args)
ts```
...
## Type Parameters [​](https://gunshi.dev/api/combinators/functions/args#type-parameters)
Type Parameter | Description  
---|---  
`T` _extends_ [`Args`](https://gunshi.dev/api/default/interfaces/Args) | The exact schema type.  
## Parameters [​](https://gunshi.dev/api/combinators/functions/args#parameters)
Parameter | Type | Description  
---|---|---  
`fields` | `T` | The argument schema object.  
## Returns [​](https://gunshi.dev/api/combinators/functions/args#returns)
`T`
The same schema object with its type inferred.
## Example [​](https://gunshi.dev/api/combinators/functions/args#example)
ts```
const common = args({
  verbose: boolean(),
...
Pager
[Previous pagecombinators](https://gunshi.dev/api/combinators/)
[Next pageboolean](https://gunshi.dev/api/combinators/functions/boolean)
