[Skip to content](https://gunshi.dev/api/combinators/type-aliases/CombinatorSchema#VPContent)
...
On this page
  * [Type Parameters](https://gunshi.dev/api/combinators/type-aliases/CombinatorSchema#type-parameters "Type Parameters")


Are you an LLM? You can read better optimized documentation at /api/combinators/type-aliases/CombinatorSchema.md for this page in Markdown format
[gunshi](https://gunshi.dev/api/) / [combinators](https://gunshi.dev/api/combinators/) / CombinatorSchema
# Type Alias: CombinatorSchema<T> [​](https://gunshi.dev/api/combinators/type-aliases/CombinatorSchema#type-alias-combinatorschema-t)
ts```
type CombinatorSchema<T> = ArgSchema & Combinator<T>;
```

**`Experimental`**
A schema produced by combinator factory functions. Any [ArgSchema](https://gunshi.dev/api/default/interfaces/ArgSchema) with a parse function qualifies.
## Type Parameters [​](https://gunshi.dev/api/combinators/type-aliases/CombinatorSchema#type-parameters)
Type Parameter | Description  
---|---  
`T` | The parsed value type.  
Last updated: 21.02.26, 15:06
Pager
[Previous pageCombinator](https://gunshi.dev/api/combinators/type-aliases/Combinator)
[Next pagecontext](https://gunshi.dev/api/context/)
