[Skip to content](https://gunshi.dev/api/combinators/type-aliases/Combinator#VPContent)
...
On this page
  * [Type Parameters](https://gunshi.dev/api/combinators/type-aliases/Combinator#type-parameters "Type Parameters")
  * [Properties](https://gunshi.dev/api/combinators/type-aliases/Combinator#properties "Properties")


Are you an LLM? You can read better optimized documentation at /api/combinators/type-aliases/Combinator.md for this page in Markdown format
[gunshi](https://gunshi.dev/api/) / [combinators](https://gunshi.dev/api/combinators/) / Combinator
# Type Alias: Combinator<T> [​](https://gunshi.dev/api/combinators/type-aliases/Combinator#type-alias-combinator-t)
ts```
...
## Type Parameters [​](https://gunshi.dev/api/combinators/type-aliases/Combinator#type-parameters)
Type Parameter | Description  
---|---  
`T` | The parsed value type.  
## Properties [​](https://gunshi.dev/api/combinators/type-aliases/Combinator#properties)
Property | Type | Description  
---|---|---  
`parse` | (`value`) => `T` | The parse function that converts a string to the desired type.  
Last updated: 21.02.26, 15:06
Pager
[Previous pageStringOptions](https://gunshi.dev/api/combinators/interfaces/StringOptions)
[Next pageCombinatorSchema](https://gunshi.dev/api/combinators/type-aliases/CombinatorSchema)
