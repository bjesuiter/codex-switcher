[Skip to content](https://gunshi.dev/api/combinators/interfaces/BooleanOptions#VPContent)
...
On this page
  * [Extends](https://gunshi.dev/api/combinators/interfaces/BooleanOptions#extends "Extends")
  * [Properties](https://gunshi.dev/api/combinators/interfaces/BooleanOptions#properties "Properties")


Are you an LLM? You can read better optimized documentation at /api/combinators/interfaces/BooleanOptions.md for this page in Markdown format
[gunshi](https://gunshi.dev/api/) / [combinators](https://gunshi.dev/api/combinators/) / BooleanOptions
# Interface: BooleanOptions [​](https://gunshi.dev/api/combinators/interfaces/BooleanOptions#interface-booleanoptions)
**`Experimental`**
Options for the [boolean](https://gunshi.dev/api/combinators/functions/boolean) combinator.
## Extends [​](https://gunshi.dev/api/combinators/interfaces/BooleanOptions#extends)
  * [`BaseOptions`](https://gunshi.dev/api/combinators/interfaces/BaseOptions)


## Properties [​](https://gunshi.dev/api/combinators/interfaces/BooleanOptions#properties)
...
Pager
[Previous pageBaseOptions](https://gunshi.dev/api/combinators/interfaces/BaseOptions)
[Next pageCombinatorOptions](https://gunshi.dev/api/combinators/interfaces/CombinatorOptions)
