[Skip to content](https://gunshi.dev/api/combinators/interfaces/IntegerOptions#VPContent)
...
On this page
  * [Extends](https://gunshi.dev/api/combinators/interfaces/IntegerOptions#extends "Extends")
  * [Properties](https://gunshi.dev/api/combinators/interfaces/IntegerOptions#properties "Properties")


Are you an LLM? You can read better optimized documentation at /api/combinators/interfaces/IntegerOptions.md for this page in Markdown format
[gunshi](https://gunshi.dev/api/) / [combinators](https://gunshi.dev/api/combinators/) / IntegerOptions
# Interface: IntegerOptions [​](https://gunshi.dev/api/combinators/interfaces/IntegerOptions#interface-integeroptions)
**`Experimental`**
Options for the [integer](https://gunshi.dev/api/combinators/functions/integer) combinator.
## Extends [​](https://gunshi.dev/api/combinators/interfaces/IntegerOptions#extends)
  * [`BaseOptions`](https://gunshi.dev/api/combinators/interfaces/BaseOptions)


## Properties [​](https://gunshi.dev/api/combinators/interfaces/IntegerOptions#properties)
...
Pager
[Previous pageFloatOptions](https://gunshi.dev/api/combinators/interfaces/FloatOptions)
[Next pageNumberOptions](https://gunshi.dev/api/combinators/interfaces/NumberOptions)
