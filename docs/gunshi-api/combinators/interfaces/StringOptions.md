[Skip to content](https://gunshi.dev/api/combinators/interfaces/StringOptions#VPContent)
...
On this page
  * [Extends](https://gunshi.dev/api/combinators/interfaces/StringOptions#extends "Extends")
  * [Properties](https://gunshi.dev/api/combinators/interfaces/StringOptions#properties "Properties")


Are you an LLM? You can read better optimized documentation at /api/combinators/interfaces/StringOptions.md for this page in Markdown format
[gunshi](https://gunshi.dev/api/) / [combinators](https://gunshi.dev/api/combinators/) / StringOptions
# Interface: StringOptions [​](https://gunshi.dev/api/combinators/interfaces/StringOptions#interface-stringoptions)
**`Experimental`**
Options for the [string](https://gunshi.dev/api/combinators/functions/string) combinator.
## Extends [​](https://gunshi.dev/api/combinators/interfaces/StringOptions#extends)
  * [`BaseOptions`](https://gunshi.dev/api/combinators/interfaces/BaseOptions)


## Properties [​](https://gunshi.dev/api/combinators/interfaces/StringOptions#properties)
...
Pager
[Previous pageNumberOptions](https://gunshi.dev/api/combinators/interfaces/NumberOptions)
[Next pageCombinator](https://gunshi.dev/api/combinators/type-aliases/Combinator)
