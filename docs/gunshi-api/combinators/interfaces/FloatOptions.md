[Skip to content](https://gunshi.dev/api/combinators/interfaces/FloatOptions#VPContent)
...
On this page
  * [Extends](https://gunshi.dev/api/combinators/interfaces/FloatOptions#extends "Extends")
  * [Properties](https://gunshi.dev/api/combinators/interfaces/FloatOptions#properties "Properties")


Are you an LLM? You can read better optimized documentation at /api/combinators/interfaces/FloatOptions.md for this page in Markdown format
[gunshi](https://gunshi.dev/api/) / [combinators](https://gunshi.dev/api/combinators/) / FloatOptions
# Interface: FloatOptions [​](https://gunshi.dev/api/combinators/interfaces/FloatOptions#interface-floatoptions)
**`Experimental`**
Options for the [float](https://gunshi.dev/api/combinators/functions/float) combinator.
## Extends [​](https://gunshi.dev/api/combinators/interfaces/FloatOptions#extends)
  * [`BaseOptions`](https://gunshi.dev/api/combinators/interfaces/BaseOptions)


## Properties [​](https://gunshi.dev/api/combinators/interfaces/FloatOptions#properties)
...
Pager
[Previous pageCombinatorOptions](https://gunshi.dev/api/combinators/interfaces/CombinatorOptions)
[Next pageIntegerOptions](https://gunshi.dev/api/combinators/interfaces/IntegerOptions)
