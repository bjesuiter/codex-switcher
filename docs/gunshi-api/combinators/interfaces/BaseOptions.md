[Skip to content](https://gunshi.dev/api/combinators/interfaces/BaseOptions#VPContent)
...
On this page
  * [Extended by](https://gunshi.dev/api/combinators/interfaces/BaseOptions#extended-by "Extended by")
  * [Properties](https://gunshi.dev/api/combinators/interfaces/BaseOptions#properties "Properties")


Are you an LLM? You can read better optimized documentation at /api/combinators/interfaces/BaseOptions.md for this page in Markdown format
[gunshi](https://gunshi.dev/api/) / [combinators](https://gunshi.dev/api/combinators/) / BaseOptions
# Interface: BaseOptions [​](https://gunshi.dev/api/combinators/interfaces/BaseOptions#interface-baseoptions)
**`Experimental`**
Common options shared by all base combinators.
## Extended by [​](https://gunshi.dev/api/combinators/interfaces/BaseOptions#extended-by)
  * [`BooleanOptions`](https://gunshi.dev/api/combinators/interfaces/BooleanOptions)
  * [`CombinatorOptions`](https://gunshi.dev/api/combinators/interfaces/CombinatorOptions)
  * [`FloatOptions`](https://gunshi.dev/api/combinators/interfaces/FloatOptions)
  * [`IntegerOptions`](https://gunshi.dev/api/combinators/interfaces/IntegerOptions)
...
## Properties [​](https://gunshi.dev/api/combinators/interfaces/BaseOptions#properties)
Property | Type | Description  
---|---|---  
`description?` | `string` |  **`Experimental`**Human-readable description for help text generation.  
`required?` | `boolean` |  **`Experimental`**Mark as required.  
`short?` | `string` |  **`Experimental`**Single character short alias.  
Last updated: 21.02.26, 15:06
Pager
[Previous pagewithDefault](https://gunshi.dev/api/combinators/functions/withDefault)
[Next pageBooleanOptions](https://gunshi.dev/api/combinators/interfaces/BooleanOptions)
