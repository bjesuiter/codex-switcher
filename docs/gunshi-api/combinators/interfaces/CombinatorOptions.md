[Skip to content](https://gunshi.dev/api/combinators/interfaces/CombinatorOptions#VPContent)
...
On this page
  * [Extends](https://gunshi.dev/api/combinators/interfaces/CombinatorOptions#extends "Extends")
  * [Type Parameters](https://gunshi.dev/api/combinators/interfaces/CombinatorOptions#type-parameters "Type Parameters")
  * [Properties](https://gunshi.dev/api/combinators/interfaces/CombinatorOptions#properties "Properties")


Are you an LLM? You can read better optimized documentation at /api/combinators/interfaces/CombinatorOptions.md for this page in Markdown format
[gunshi](https://gunshi.dev/api/) / [combinators](https://gunshi.dev/api/combinators/) / CombinatorOptions
# Interface: CombinatorOptions<T> [​](https://gunshi.dev/api/combinators/interfaces/CombinatorOptions#interface-combinatoroptions-t)
**`Experimental`**
Options for the [combinator](https://gunshi.dev/api/combinators/functions/combinator) factory function.
## Extends [​](https://gunshi.dev/api/combinators/interfaces/CombinatorOptions#extends)
  * [`BaseOptions`](https://gunshi.dev/api/combinators/interfaces/BaseOptions)


## Type Parameters [​](https://gunshi.dev/api/combinators/interfaces/CombinatorOptions#type-parameters)
Type Parameter | Description  
---|---  
`T` | The parsed value type.  
## Properties [​](https://gunshi.dev/api/combinators/interfaces/CombinatorOptions#properties)
Property | Type | Description | Inherited from  
---|---|---|---  
`description?` | `string` |  **`Experimental`**Human-readable description for help text generation. |  [`BaseOptions`](https://gunshi.dev/api/combinators/interfaces/BaseOptions).[`description`](https://gunshi.dev/api/combinators/interfaces/BaseOptions#description)  
...
`required?` | `boolean` |  **`Experimental`**Mark as required. |  [`BaseOptions`](https://gunshi.dev/api/combinators/interfaces/BaseOptions).[`required`](https://gunshi.dev/api/combinators/interfaces/BaseOptions#required)  
`short?` | `string` |  **`Experimental`**Single character short alias. |  [`BaseOptions`](https://gunshi.dev/api/combinators/interfaces/BaseOptions).[`short`](https://gunshi.dev/api/combinators/interfaces/BaseOptions#short)  
Last updated: 21.02.26, 15:06
Pager
[Previous pageBooleanOptions](https://gunshi.dev/api/combinators/interfaces/BooleanOptions)
[Next pageFloatOptions](https://gunshi.dev/api/combinators/interfaces/FloatOptions)
