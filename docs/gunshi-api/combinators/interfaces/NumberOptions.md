[Skip to content](https://gunshi.dev/api/combinators/interfaces/NumberOptions#VPContent)
...
On this page
  * [Extends](https://gunshi.dev/api/combinators/interfaces/NumberOptions#extends "Extends")
  * [Properties](https://gunshi.dev/api/combinators/interfaces/NumberOptions#properties "Properties")


Are you an LLM? You can read better optimized documentation at /api/combinators/interfaces/NumberOptions.md for this page in Markdown format
[gunshi](https://gunshi.dev/api/) / [combinators](https://gunshi.dev/api/combinators/) / NumberOptions
# Interface: NumberOptions [​](https://gunshi.dev/api/combinators/interfaces/NumberOptions#interface-numberoptions)
**`Experimental`**
Options for the [number](https://gunshi.dev/api/combinators/functions/number) combinator.
## Extends [​](https://gunshi.dev/api/combinators/interfaces/NumberOptions#extends)
  * [`BaseOptions`](https://gunshi.dev/api/combinators/interfaces/BaseOptions)


## Properties [​](https://gunshi.dev/api/combinators/interfaces/NumberOptions#properties)
...
Pager
[Previous pageIntegerOptions](https://gunshi.dev/api/combinators/interfaces/IntegerOptions)
[Next pageStringOptions](https://gunshi.dev/api/combinators/interfaces/StringOptions)
