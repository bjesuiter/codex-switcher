[Skip to content](https://gunshi.dev/api/generator/#VPContent)
...
On this page
  * [Example](https://gunshi.dev/api/generator/#example "Example")
  * [Functions](https://gunshi.dev/api/generator/#functions "Functions")
  * [Type Aliases](https://gunshi.dev/api/generator/#type-aliases "Type Aliases")


Are you an LLM? You can read better optimized documentation at /api/generator.md for this page in Markdown format
[gunshi](https://gunshi.dev/api/) / generator
# generator [​](https://gunshi.dev/api/generator/#generator)
The entry for usage generator.
## Example [​](https://gunshi.dev/api/generator/#example)
js```
import { generate } from 'gunshi/generator'
```

## Functions [​](https://gunshi.dev/api/generator/#functions)
Function | Description  
---|---  
[generate](https://gunshi.dev/api/generator/functions/generate) | Generate the command usage.  
## Type Aliases [​](https://gunshi.dev/api/generator/#type-aliases)
Type Alias | Description  
---|---  
[GenerateOptions](https://gunshi.dev/api/generator/type-aliases/GenerateOptions) | generate options of `generate` function.  
Pager
[Previous pagelazyWithTypes](https://gunshi.dev/api/definition/functions/lazyWithTypes)
[Next pagegenerate](https://gunshi.dev/api/generator/functions/generate)
