[Skip to content](https://gunshi.dev/api/#VPContent)
...
On this page
  * [Modules](https://gunshi.dev/api/#modules "Modules")


Are you an LLM? You can read better optimized documentation at /api.md for this page in Markdown format
# gunshi [​](https://gunshi.dev/api/#gunshi)
## Modules [​](https://gunshi.dev/api/#modules)
Module | Description  
---|---  
[combinators](https://gunshi.dev/api/combinators/) | Parser combinator entry point.  
[context](https://gunshi.dev/api/context/) | The entry for gunshi context. This module is exported for the purpose of testing the command.  
[default](https://gunshi.dev/api/default/) | gunshi cli entry point.  
[definition](https://gunshi.dev/api/definition/) | The entry for gunshi command definition.  
[generator](https://gunshi.dev/api/generator/) | The entry for usage generator.  
[plugin](https://gunshi.dev/api/plugin/) | The entry point for Gunshi plugin module.  
[renderer](https://gunshi.dev/api/renderer/) | The entry point for Gunshi renderer.  
Pager
[Next pageWhat's Gunshi?](https://gunshi.dev/guide/introduction/what-is-gunshi)
