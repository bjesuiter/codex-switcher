[Skip to content](https://gunshi.dev/api/combinators/#VPContent)
...
On this page
  * [Example](https://gunshi.dev/api/combinators/#example "Example")
  * [Functions](https://gunshi.dev/api/combinators/#functions "Functions")
  * [Interfaces](https://gunshi.dev/api/combinators/#interfaces "Interfaces")
  * [Type Aliases](https://gunshi.dev/api/combinators/#type-aliases "Type Aliases")


Are you an LLM? You can read better optimized documentation at /api/combinators.md for this page in Markdown format
[gunshi](https://gunshi.dev/api/) / combinators
# combinators [​](https://gunshi.dev/api/combinators/#combinators)
**`Experimental`**
...
## Example [​](https://gunshi.dev/api/combinators/#example)
ts```
...
## Functions [​](https://gunshi.dev/api/combinators/#functions)
...
[unrequired](https://gunshi.dev/api/combinators/functions/unrequired) | -  
[withDefault](https://gunshi.dev/api/combinators/functions/withDefault) | -  
## Interfaces [​](https://gunshi.dev/api/combinators/#interfaces)
Interface | Description  
---|---  
[BaseOptions](https://gunshi.dev/api/combinators/interfaces/BaseOptions) | Common options shared by all base combinators.  
[BooleanOptions](https://gunshi.dev/api/combinators/interfaces/BooleanOptions) | Options for the [boolean](https://gunshi.dev/api/combinators/functions/boolean) combinator.  
[CombinatorOptions](https://gunshi.dev/api/combinators/interfaces/CombinatorOptions) | Options for the [combinator](https://gunshi.dev/api/combinators/functions/combinator) factory function.  
[FloatOptions](https://gunshi.dev/api/combinators/interfaces/FloatOptions) | Options for the [float](https://gunshi.dev/api/combinators/functions/float) combinator.  
[IntegerOptions](https://gunshi.dev/api/combinators/interfaces/IntegerOptions) | Options for the [integer](https://gunshi.dev/api/combinators/functions/integer) combinator.  
[NumberOptions](https://gunshi.dev/api/combinators/interfaces/NumberOptions) | Options for the [number](https://gunshi.dev/api/combinators/functions/number) combinator.  
[StringOptions](https://gunshi.dev/api/combinators/interfaces/StringOptions) | Options for the [string](https://gunshi.dev/api/combinators/functions/string) combinator.  
## Type Aliases [​](https://gunshi.dev/api/combinators/#type-aliases)
Type Alias | Description  
---|---  
[Combinator](https://gunshi.dev/api/combinators/type-aliases/Combinator) | A combinator produced by combinator factory functions.  
[CombinatorSchema](https://gunshi.dev/api/combinators/type-aliases/CombinatorSchema) | A schema produced by combinator factory functions. Any [ArgSchema](https://gunshi.dev/api/default/interfaces/ArgSchema) with a parse function qualifies.  
Last updated: 21.02.26, 15:06
Pager
[Previous pagePlugin List](https://gunshi.dev/guide/plugin/list)
[Next pageargs](https://gunshi.dev/api/combinators/functions/args)
