[Skip to content](https://gunshi.dev/api/generator/type-aliases/GenerateOptions#VPContent)
...
On this page
  * [Type Parameters](https://gunshi.dev/api/generator/type-aliases/GenerateOptions#type-parameters "Type Parameters")


Are you an LLM? You can read better optimized documentation at /api/generator/type-aliases/GenerateOptions.md for this page in Markdown format
[gunshi](https://gunshi.dev/api/) / [generator](https://gunshi.dev/api/generator/) / GenerateOptions
# Type Alias: GenerateOptions<G> [​](https://gunshi.dev/api/generator/type-aliases/GenerateOptions#type-alias-generateoptions-g)
ts```
type GenerateOptions<G> = CliOptions<G>;
```

generate options of `generate` function.
## Type Parameters [​](https://gunshi.dev/api/generator/type-aliases/GenerateOptions#type-parameters)
Type Parameter | Default type | Description  
---|---|---  
`G` _extends_ [`GunshiParamsConstraint`](https://gunshi.dev/api/default/type-aliases/GunshiParamsConstraint) | [`DefaultGunshiParams`](https://gunshi.dev/api/default/type-aliases/DefaultGunshiParams) | A type extending GunshiParams to specify the shape of [`CliOptions`](https://gunshi.dev/api/default/interfaces/CliOptions).  
Pager
[Previous pagegenerate](https://gunshi.dev/api/generator/functions/generate)
[Next pageplugin](https://gunshi.dev/api/plugin/)
