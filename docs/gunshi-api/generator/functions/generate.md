[Skip to content](https://gunshi.dev/api/generator/functions/generate#VPContent)
...
On this page
  * [Type Parameters](https://gunshi.dev/api/generator/functions/generate#type-parameters "Type Parameters")
  * [Parameters](https://gunshi.dev/api/generator/functions/generate#parameters "Parameters")
  * [Returns](https://gunshi.dev/api/generator/functions/generate#returns "Returns")


Are you an LLM? You can read better optimized documentation at /api/generator/functions/generate.md for this page in Markdown format
[gunshi](https://gunshi.dev/api/) / [generator](https://gunshi.dev/api/generator/) / generate
# Function: generate() [​](https://gunshi.dev/api/generator/functions/generate#function-generate)
ts```
function generate<G>(
   command, 
   entry, 
...
## Type Parameters [​](https://gunshi.dev/api/generator/functions/generate#type-parameters)
Type Parameter | Default type | Description  
---|---|---  
`G` _extends_ [`GunshiParamsConstraint`](https://gunshi.dev/api/default/type-aliases/GunshiParamsConstraint) | [`DefaultGunshiParams`](https://gunshi.dev/api/default/type-aliases/DefaultGunshiParams) | A type extending GunshiParams to specify the shape of command parameters.  
## Parameters [​](https://gunshi.dev/api/generator/functions/generate#parameters)
...
`entry` | | [`Command`](https://gunshi.dev/api/default/interfaces/Command)<`G`> | [`LazyCommand`](https://gunshi.dev/api/default/type-aliases/LazyCommand)<`G`> | A [`entry command`](https://gunshi.dev/api/default/interfaces/Command)  
`options` |  [`GenerateOptions`](https://gunshi.dev/api/generator/type-aliases/GenerateOptions)<`G`> | A [`cli options`](https://gunshi.dev/api/generator/type-aliases/GenerateOptions)  
## Returns [​](https://gunshi.dev/api/generator/functions/generate#returns)
`Promise`<`string`>
A rendered usage.
Pager
[Previous pagegenerator](https://gunshi.dev/api/generator/)
[Next pageGenerateOptions](https://gunshi.dev/api/generator/type-aliases/GenerateOptions)
