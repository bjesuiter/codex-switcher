[Skip to content](https://gunshi.dev/api/default/variables/ANONYMOUS_COMMAND_NAME#VPContent)
...
Are you an LLM? You can read better optimized documentation at /api/default/variables/ANONYMOUS_COMMAND_NAME.md for this page in Markdown format
[gunshi](https://gunshi.dev/api/) / [default](https://gunshi.dev/api/default/) / ANONYMOUS_COMMAND_NAME
# Variable: ANONYMOUS_COMMAND_NAME [​](https://gunshi.dev/api/default/variables/ANONYMOUS_COMMAND_NAME#variable-anonymous-command-name)
ts```
const ANONYMOUS_COMMAND_NAME: "(anonymous)" = '(anonymous)';
```

Pager
[Previous pagedefault](https://gunshi.dev/api/default/)
[Next pagecli](https://gunshi.dev/api/default/functions/cli)
