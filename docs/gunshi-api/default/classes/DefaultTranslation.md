[Skip to content](https://gunshi.dev/api/default/classes/DefaultTranslation#VPContent)
...
On this page
  * [Implements](https://gunshi.dev/api/default/classes/DefaultTranslation#implements "Implements")
  * [Constructors](https://gunshi.dev/api/default/classes/DefaultTranslation#constructors "Constructors")
  * [Methods](https://gunshi.dev/api/default/classes/DefaultTranslation#methods "Methods")


Are you an LLM? You can read better optimized documentation at /api/default/classes/DefaultTranslation.md for this page in Markdown format
[gunshi](https://gunshi.dev/api/) / [default](https://gunshi.dev/api/default/) / DefaultTranslation
# Class: DefaultTranslation [​](https://gunshi.dev/api/default/classes/DefaultTranslation#class-defaulttranslation)
Default implementation of `TranslationAdapter`.
## Implements [​](https://gunshi.dev/api/default/classes/DefaultTranslation#implements)
  * `TranslationAdapter`


## Constructors [​](https://gunshi.dev/api/default/classes/DefaultTranslation#constructors)
### Constructor [​](https://gunshi.dev/api/default/classes/DefaultTranslation#constructor)
ts```
new DefaultTranslation(options): DefaultTranslation;
```

Creates a new instance of DefaultTranslation.
#### Parameters [​](https://gunshi.dev/api/default/classes/DefaultTranslation#parameters)
Parameter | Type | Description  
---|---|---  
`options` | `TranslationAdapterFactoryOptions` | Options for the translation adapter, see `TranslationAdapterFactoryOptions`  
#### Returns [​](https://gunshi.dev/api/default/classes/DefaultTranslation#returns)
`DefaultTranslation`
## Methods [​](https://gunshi.dev/api/default/classes/DefaultTranslation#methods)
### getMessage() [​](https://gunshi.dev/api/default/classes/DefaultTranslation#getmessage)
ts```
getMessage(locale, key): string | undefined;
```

Get a message of locale.
#### Parameters [​](https://gunshi.dev/api/default/classes/DefaultTranslation#parameters-1)
Parameter | Type | Description  
---|---|---  
`locale` | `string` | A locale of message (BCP 47 language tag)  
`key` | `string` | A key of message resource  
#### Returns [​](https://gunshi.dev/api/default/classes/DefaultTranslation#returns-1)
`string` | `undefined`
A message of locale. If message not found, return `undefined`.
#### Implementation of [​](https://gunshi.dev/api/default/classes/DefaultTranslation#implementation-of)
ts```
TranslationAdapter.getMessage
```

* * *
### getResource() [​](https://gunshi.dev/api/default/classes/DefaultTranslation#getresource)
ts```
getResource(locale): Record<string, string> | undefined;
```

Get a resource of locale.
#### Parameters [​](https://gunshi.dev/api/default/classes/DefaultTranslation#parameters-2)
Parameter | Type | Description  
---|---|---  
`locale` | `string` | A locale of resource (BCP 47 language tag)  
#### Returns [​](https://gunshi.dev/api/default/classes/DefaultTranslation#returns-2)
`Record`<`string`, `string`> | `undefined`
A resource of locale. If resource not found, return `undefined`.
#### Implementation of [​](https://gunshi.dev/api/default/classes/DefaultTranslation#implementation-of-1)
ts```
TranslationAdapter.getResource
```

* * *
### setResource() [​](https://gunshi.dev/api/default/classes/DefaultTranslation#setresource)
ts```
setResource(locale, resource): void;
```

Set a resource of locale.
#### Parameters [​](https://gunshi.dev/api/default/classes/DefaultTranslation#parameters-3)
Parameter | Type | Description  
---|---|---  
`locale` | `string` | A locale of resource (BCP 47 language tag)  
`resource` |  `Record`<`string`, `string`> | A resource of locale  
#### Returns [​](https://gunshi.dev/api/default/classes/DefaultTranslation#returns-3)
`void`
#### Implementation of [​](https://gunshi.dev/api/default/classes/DefaultTranslation#implementation-of-2)
ts```
TranslationAdapter.setResource
```

* * *
### translate() [​](https://gunshi.dev/api/default/classes/DefaultTranslation#translate)
ts```
translate(
   locale, 
   key, 
...
Translate a message.
#### Parameters [​](https://gunshi.dev/api/default/classes/DefaultTranslation#parameters-4)
Parameter | Type | Description  
---|---|---  
`locale` | `string` | A locale of message (BCP 47 language tag)  
`key` | `string` | A key of message resource  
`values` |  `Record`<`string`, `unknown`> | A values to interpolate in the message  
#### Returns [​](https://gunshi.dev/api/default/classes/DefaultTranslation#returns-4)
`string` | `undefined`
A translated message, if message is not translated, return `undefined`.
#### Implementation of [​](https://gunshi.dev/api/default/classes/DefaultTranslation#implementation-of-3)
ts```
TranslationAdapter.translate
```

Pager
[Previous pageresolveArgs](https://gunshi.dev/api/default/functions/resolveArgs)
[Next pageArgs](https://gunshi.dev/api/default/interfaces/Args)
