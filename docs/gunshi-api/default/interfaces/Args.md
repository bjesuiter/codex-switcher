[Skip to content](https://gunshi.dev/api/default/interfaces/Args#VPContent)
...
On this page
  * [Indexable](https://gunshi.dev/api/default/interfaces/Args#indexable "Indexable")


Are you an LLM? You can read better optimized documentation at /api/default/interfaces/Args.md for this page in Markdown format
[gunshi](https://gunshi.dev/api/) / [default](https://gunshi.dev/api/default/) / Args
# Interface: Args [​](https://gunshi.dev/api/default/interfaces/Args#interface-args)
An object that contains [argument schema](https://gunshi.dev/api/default/interfaces/ArgSchema).
This type is used to define the structure and validation rules for command line arguments.
## Indexable [​](https://gunshi.dev/api/default/interfaces/Args#indexable)
ts```
[option: string]: ArgSchema
```

Pager
[Previous pageDefaultTranslation](https://gunshi.dev/api/default/classes/DefaultTranslation)
[Next pageArgSchema](https://gunshi.dev/api/default/interfaces/ArgSchema)
