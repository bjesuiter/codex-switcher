[Skip to content](https://gunshi.dev/api/default/interfaces/CommandEnvironment#VPContent)
...
Are you an LLM? You can read better optimized documentation at /api/default/interfaces/CommandEnvironment.md for this page in Markdown format
[gunshi](https://gunshi.dev/api/) / [default](https://gunshi.dev/api/default/) / CommandEnvironment
# Interface: CommandEnvironment<G> [​](https://gunshi.dev/api/default/interfaces/CommandEnvironment#interface-commandenvironment-g)
Command environment.
## Type Parameters [​](https://gunshi.dev/api/default/interfaces/CommandEnvironment#type-parameters)
Type Parameter | Default type | Description  
---|---|---  
`G` _extends_ [`GunshiParamsConstraint`](https://gunshi.dev/api/default/type-aliases/GunshiParamsConstraint) | [`DefaultGunshiParams`](https://gunshi.dev/api/default/type-aliases/DefaultGunshiParams) | A type extending [`GunshiParams`](https://gunshi.dev/api/default/interfaces/GunshiParams) to specify the shape of command environments.  
## Properties [​](https://gunshi.dev/api/default/interfaces/CommandEnvironment#properties)
Property | Type | Description  
---|---|---  
`cwd` |  `string` | `undefined` | Current working directory. **See** [`CliOptions.cwd`](https://gunshi.dev/api/default/interfaces/CliOptions#cwd)  
`description` |  `string` | `undefined` | Command description. **See** [`CliOptions.description`](https://gunshi.dev/api/default/interfaces/CliOptions#description)  
`leftMargin` | `number` | Left margin of the command output. **Default** `2` **See** [`CliOptions.leftMargin`](https://gunshi.dev/api/default/interfaces/CliOptions#leftmargin)  
`middleMargin` | `number` | Middle margin of the command output. **Default** `10` **See** [`CliOptions.middleMargin`](https://gunshi.dev/api/default/interfaces/CliOptions#middlemargin)  
`name` |  `string` | `undefined` | Command name. **See** [`CliOptions.name`](https://gunshi.dev/api/default/interfaces/CliOptions#name)  
`onAfterCommand` | | (`ctx`, `result`) => [`Awaitable`](https://gunshi.dev/api/default/type-aliases/Awaitable)<`void`> | `undefined` | Hook that runs after successful command execution **See** [`CliOptions.onAfterCommand`](https://gunshi.dev/api/default/interfaces/CliOptions#onaftercommand) **Since** v0.27.0  
`onBeforeCommand` | | (`ctx`) => [`Awaitable`](https://gunshi.dev/api/default/type-aliases/Awaitable)<`void`> | `undefined` | Hook that runs before any command execution **See** [`CliOptions.onBeforeCommand`](https://gunshi.dev/api/default/interfaces/CliOptions#onbeforecommand) **Since** v0.27.0  
`onErrorCommand` | | (`ctx`, `error`) => [`Awaitable`](https://gunshi.dev/api/default/type-aliases/Awaitable)<`void`> | `undefined` | Hook that runs when a command throws an error **See** [`CliOptions.onErrorCommand`](https://gunshi.dev/api/default/interfaces/CliOptions#onerrorcommand) **Since** v0.27.0  
`renderHeader` | (`ctx`) => `Promise`<`string`> | `null` | `undefined` | Render function the header section in the command usage.  
`renderUsage` | (`ctx`) => `Promise`<`string`> | `null` | `undefined` | Render function the command usage.  
`renderValidationErrors` | (`ctx`, `error`) => `Promise`<`string`> | `null` | `undefined` | Render function the validation errors.  
`subCommands` | | `Map`<`string`, | [`Command`](https://gunshi.dev/api/default/interfaces/Command)<`any`> | [`LazyCommand`](https://gunshi.dev/api/default/type-aliases/LazyCommand)<`any`, { }>> | `undefined` | Sub commands. **See** [`CliOptions.subCommands`](https://gunshi.dev/api/default/interfaces/CliOptions#subcommands)  
`usageOptionType` | `boolean` | Whether to display the usage option type. **Default** `false` **See** [`CliOptions.usageOptionType`](https://gunshi.dev/api/default/interfaces/CliOptions#usageoptiontype)  
`usageOptionValue` | `boolean` | Whether to display the option value. **Default** `true` **See** [`CliOptions.usageOptionValue`](https://gunshi.dev/api/default/interfaces/CliOptions#usageoptionvalue)  
`usageSilent` | `boolean` | Whether to display the command usage. **Default** `false` **See** [`CliOptions.usageSilent`](https://gunshi.dev/api/default/interfaces/CliOptions#usagesilent)  
`version` |  `string` | `undefined` | Command version. **See** [`CliOptions.version`](https://gunshi.dev/api/default/interfaces/CliOptions#version)  
Pager
[Previous pageCommandContextExtension](https://gunshi.dev/api/default/interfaces/CommandContextExtension)
[Next pageGunshiParams](https://gunshi.dev/api/default/interfaces/GunshiParams)
