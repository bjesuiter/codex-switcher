[Skip to content](https://gunshi.dev/api/default/interfaces/CliOptions#VPContent)
...
On this page
  * [Type Parameters](https://gunshi.dev/api/default/interfaces/CliOptions#type-parameters "Type Parameters")
  * [Properties](https://gunshi.dev/api/default/interfaces/CliOptions#properties "Properties")


Are you an LLM? You can read better optimized documentation at /api/default/interfaces/CliOptions.md for this page in Markdown format
[gunshi](https://gunshi.dev/api/) / [default](https://gunshi.dev/api/default/) / CliOptions
# Interface: CliOptions<G> [​](https://gunshi.dev/api/default/interfaces/CliOptions#interface-clioptions-g)
CLI options of [`cli`](https://gunshi.dev/api/default/functions/cli) function.
## Type Parameters [​](https://gunshi.dev/api/default/interfaces/CliOptions#type-parameters)
Type Parameter | Default type | Description  
---|---|---  
`G` _extends_ [`GunshiParamsConstraint`](https://gunshi.dev/api/default/type-aliases/GunshiParamsConstraint) | [`DefaultGunshiParams`](https://gunshi.dev/api/default/type-aliases/DefaultGunshiParams) | A type extending [`GunshiParams`](https://gunshi.dev/api/default/interfaces/GunshiParams) to specify the shape of cli options.  
## Properties [​](https://gunshi.dev/api/default/interfaces/CliOptions#properties)
...
`onAfterCommand?` | (`ctx`, `result`) => [`Awaitable`](https://gunshi.dev/api/default/type-aliases/Awaitable)<`void`> | Hook that runs after successful command execution **Since** v0.27.0  
`onBeforeCommand?` | (`ctx`) => [`Awaitable`](https://gunshi.dev/api/default/type-aliases/Awaitable)<`void`> | Hook that runs before any command execution **Since** v0.27.0  
`onErrorCommand?` | (`ctx`, `error`) => [`Awaitable`](https://gunshi.dev/api/default/type-aliases/Awaitable)<`void`> | Hook that runs when a command throws an error **Since** v0.27.0  
`plugins?` |  [`Plugin`](https://gunshi.dev/api/default/type-aliases/Plugin)[] | User plugins. **Since** v0.27.0  
`renderHeader?` | (`ctx`) => `Promise`<`string`> | `null` | Render function the header section in the command usage.  
`renderUsage?` | (`ctx`) => `Promise`<`string`> | `null` | Render function the command usage.  
`renderValidationErrors?` | (`ctx`, `error`) => `Promise`<`string`> | `null` | Render function the validation errors.  
`subCommands?` | | `Record`<`string`, [`SubCommandable`](https://gunshi.dev/api/default/interfaces/SubCommandable)> | `Map`<`string`, [`SubCommandable`](https://gunshi.dev/api/default/interfaces/SubCommandable)> | Sub commands.  
...
Pager
[Previous pageArgToken](https://gunshi.dev/api/default/interfaces/ArgToken)
[Next pageCommand](https://gunshi.dev/api/default/interfaces/Command)
