[Skip to content](https://gunshi.dev/api/default/interfaces/CommandContextExtension#VPContent)
...
On this page
  * [Since](https://gunshi.dev/api/default/interfaces/CommandContextExtension#since "Since")
  * [Type Parameters](https://gunshi.dev/api/default/interfaces/CommandContextExtension#type-parameters "Type Parameters")
  * [Properties](https://gunshi.dev/api/default/interfaces/CommandContextExtension#properties "Properties")


Are you an LLM? You can read better optimized documentation at /api/default/interfaces/CommandContextExtension.md for this page in Markdown format
[gunshi](https://gunshi.dev/api/) / [default](https://gunshi.dev/api/default/) / CommandContextExtension
# Interface: CommandContextExtension<E> [​](https://gunshi.dev/api/default/interfaces/CommandContextExtension#interface-commandcontextextension-e)
Command context extension
## Since [​](https://gunshi.dev/api/default/interfaces/CommandContextExtension#since)
v0.27.0
## Type Parameters [​](https://gunshi.dev/api/default/interfaces/CommandContextExtension#type-parameters)
Type Parameter | Default type | Description  
---|---|---  
`E` _extends_ [`GunshiParams`](https://gunshi.dev/api/default/interfaces/GunshiParams)[`"extensions"`] |  [`DefaultGunshiParams`](https://gunshi.dev/api/default/type-aliases/DefaultGunshiParams)[`"extensions"`] | A type extending [`GunshiParams.extensions`](https://gunshi.dev/api/default/interfaces/GunshiParams#extensions) to specify the shape of the extension.  
## Properties [​](https://gunshi.dev/api/default/interfaces/CommandContextExtension#properties)
Property | Modifier | Type | Description  
---|---|---|---  
`factory` | `readonly` | (`ctx`, `cmd`) => [`Awaitable`](https://gunshi.dev/api/default/type-aliases/Awaitable)<`E`> | Plugin extension factory  
`key` | `readonly` | `symbol` | Plugin identifier  
`onFactory?` | `readonly` | (`ctx`, `cmd`) => [`Awaitable`](https://gunshi.dev/api/default/type-aliases/Awaitable)<`void`> | Plugin extension factory after hook  
Pager
[Previous pageCommandContext](https://gunshi.dev/api/default/interfaces/CommandContext)
[Next pageCommandEnvironment](https://gunshi.dev/api/default/interfaces/CommandEnvironment)
