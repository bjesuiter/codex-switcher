[Skip to content](https://gunshi.dev/api/default/interfaces/Command#VPContent)
...
On this page
  * [Type Parameters](https://gunshi.dev/api/default/interfaces/Command#type-parameters "Type Parameters")
  * [Properties](https://gunshi.dev/api/default/interfaces/Command#properties "Properties")


Are you an LLM? You can read better optimized documentation at /api/default/interfaces/Command.md for this page in Markdown format
[gunshi](https://gunshi.dev/api/) / [default](https://gunshi.dev/api/default/) / Command
# Interface: Command<G> [​](https://gunshi.dev/api/default/interfaces/Command#interface-command-g)
Command interface.
## Type Parameters [​](https://gunshi.dev/api/default/interfaces/Command#type-parameters)
Type Parameter | Default type | Description  
---|---|---  
`G` _extends_ [`GunshiParamsConstraint`](https://gunshi.dev/api/default/type-aliases/GunshiParamsConstraint) | [`DefaultGunshiParams`](https://gunshi.dev/api/default/type-aliases/DefaultGunshiParams) | The Gunshi parameters constraint  
## Properties [​](https://gunshi.dev/api/default/interfaces/Command#properties)
...
`examples?` | | `string` | [`CommandExamplesFetcher`](https://gunshi.dev/api/default/type-aliases/CommandExamplesFetcher)<`G`> | Command examples. examples of how to use the command.  
...
`rendering?` |  [`RenderingOptions`](https://gunshi.dev/api/default/interfaces/RenderingOptions)<`G`> | Rendering control options **Since** v0.27.0  
`run?` |  [`CommandRunner`](https://gunshi.dev/api/default/type-aliases/CommandRunner)<`G`> | Command runner. it's the command to be executed  
`subCommands?` | | `Record`<`string`, [`SubCommandable`](https://gunshi.dev/api/default/interfaces/SubCommandable)> | `Map`<`string`, [`SubCommandable`](https://gunshi.dev/api/default/interfaces/SubCommandable)> | Nested sub-commands for this command. Allows building command trees like `git remote add`. Each key is the sub-command name, and the value is a command or lazy command. **Since** v0.28.0  
`toKebab?` | `boolean` | Whether to convert the camel-case style argument name to kebab-case. If you will set to `true`, All [`Command.args`](https://gunshi.dev/api/default/interfaces/Command#args) names will be converted to kebab-case.  
Pager
[Previous pageCliOptions](https://gunshi.dev/api/default/interfaces/CliOptions)
[Next pageCommandContext](https://gunshi.dev/api/default/interfaces/CommandContext)
