[Skip to content](https://gunshi.dev/api/default/interfaces/ArgToken#VPContent)
...
On this page
  * [Properties](https://gunshi.dev/api/default/interfaces/ArgToken#properties "Properties")


Are you an LLM? You can read better optimized documentation at /api/default/interfaces/ArgToken.md for this page in Markdown format
[gunshi](https://gunshi.dev/api/) / [default](https://gunshi.dev/api/default/) / ArgToken
# Interface: ArgToken [​](https://gunshi.dev/api/default/interfaces/ArgToken#interface-argtoken)
Argument token.
## Properties [​](https://gunshi.dev/api/default/interfaces/ArgToken#properties)
...
Pager
[Previous pageArgSchema](https://gunshi.dev/api/default/interfaces/ArgSchema)
[Next pageCliOptions](https://gunshi.dev/api/default/interfaces/CliOptions)
