[Skip to content](https://gunshi.dev/api/default/interfaces/PluginOptions#VPContent)
...
On this page
  * [Since](https://gunshi.dev/api/default/interfaces/PluginOptions#since "Since")
  * [Type Parameters](https://gunshi.dev/api/default/interfaces/PluginOptions#type-parameters "Type Parameters")
  * [Properties](https://gunshi.dev/api/default/interfaces/PluginOptions#properties "Properties")


Are you an LLM? You can read better optimized documentation at /api/default/interfaces/PluginOptions.md for this page in Markdown format
[gunshi](https://gunshi.dev/api/) / [default](https://gunshi.dev/api/default/) / PluginOptions
# Interface: PluginOptions<DepExt, Id, Deps, Ext, ResolvedDepExt, PluginExt, MergedExt> [​](https://gunshi.dev/api/default/interfaces/PluginOptions#interface-pluginoptions-depext-id-deps-ext-resolveddepext-pluginext-mergedext)
Plugin definition options
## Since [​](https://gunshi.dev/api/default/interfaces/PluginOptions#since)
v0.27.0
## Type Parameters [​](https://gunshi.dev/api/default/interfaces/PluginOptions#type-parameters)
Type Parameter | Default type  
---|---  
`DepExt` _extends_ [`ExtendContext`](https://gunshi.dev/api/default/type-aliases/ExtendContext) |  [`DefaultGunshiParams`](https://gunshi.dev/api/default/type-aliases/DefaultGunshiParams)[`"extensions"`]  
`Id` _extends_ `string` | `string`  
`Deps` _extends_ `ReadonlyArray`<[`PluginDependency`](https://gunshi.dev/api/default/interfaces/PluginDependency) | `string`> | ([`PluginDependency`](https://gunshi.dev/api/default/interfaces/PluginDependency) | `string`)[]  
`Ext` _extends_ `Record`<`string`, `unknown`> | `object`  
`ResolvedDepExt` _extends_ [`GunshiParams`](https://gunshi.dev/api/default/interfaces/GunshiParams) |  [`GunshiParams`](https://gunshi.dev/api/default/interfaces/GunshiParams)<{ `args`: [`Args`](https://gunshi.dev/api/default/interfaces/Args); `extensions`: `InferDependencyExtensions`<`Deps`, `DepExt`>; }>  
`PluginExt` _extends_ [`PluginExtension`](https://gunshi.dev/api/default/type-aliases/PluginExtension)<`Ext`, `ResolvedDepExt`> |  [`PluginExtension`](https://gunshi.dev/api/default/type-aliases/PluginExtension)<`Ext`, `ResolvedDepExt`>  
`MergedExt` _extends_ [`GunshiParams`](https://gunshi.dev/api/default/interfaces/GunshiParams) |  [`GunshiParams`](https://gunshi.dev/api/default/interfaces/GunshiParams)<{ `args`: [`Args`](https://gunshi.dev/api/default/interfaces/Args); `extensions`: `MergeExtension`<`Id`, `InferDependencyExtensions`<`Deps`, `DepExt`>, `Awaited`<`ReturnType`<`PluginExt`>>>; }>  
## Properties [​](https://gunshi.dev/api/default/interfaces/PluginOptions#properties)
...
`onExtension?` |  [`OnPluginExtension`](https://gunshi.dev/api/default/type-aliases/OnPluginExtension)<`MergedExt`> | Callback for when the plugin is extended with `extension` option.  
`setup?` |  [`PluginFunction`](https://gunshi.dev/api/default/type-aliases/PluginFunction)<`MergedExt`> | Plugin setup function  
Pager
[Previous pagePluginDependency](https://gunshi.dev/api/default/interfaces/PluginDependency)
[Next pagePluginWithExtension](https://gunshi.dev/api/default/interfaces/PluginWithExtension)
