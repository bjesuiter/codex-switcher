[Skip to content](https://gunshi.dev/api/default/interfaces/PluginWithoutExtension#VPContent)
...
On this page
  * [Extends](https://gunshi.dev/api/default/interfaces/PluginWithoutExtension#extends "Extends")
  * [Type Parameters](https://gunshi.dev/api/default/interfaces/PluginWithoutExtension#type-parameters "Type Parameters")
  * [Parameters](https://gunshi.dev/api/default/interfaces/PluginWithoutExtension#parameters "Parameters")
  * [Returns](https://gunshi.dev/api/default/interfaces/PluginWithoutExtension#returns "Returns")
  * [Properties](https://gunshi.dev/api/default/interfaces/PluginWithoutExtension#properties "Properties")


Are you an LLM? You can read better optimized documentation at /api/default/interfaces/PluginWithoutExtension.md for this page in Markdown format
[gunshi](https://gunshi.dev/api/) / [default](https://gunshi.dev/api/default/) / PluginWithoutExtension
# Interface: PluginWithoutExtension()<E> [​](https://gunshi.dev/api/default/interfaces/PluginWithoutExtension#interface-pluginwithoutextension-e)
...
## Extends [​](https://gunshi.dev/api/default/interfaces/PluginWithoutExtension#extends)
  * [`Plugin`](https://gunshi.dev/api/default/type-aliases/Plugin)<`E`>


## Type Parameters [​](https://gunshi.dev/api/default/interfaces/PluginWithoutExtension#type-parameters)
Type Parameter | Default type | Description  
---|---|---  
`E` _extends_ [`GunshiParams`](https://gunshi.dev/api/default/interfaces/GunshiParams)[`"extensions"`] |  [`DefaultGunshiParams`](https://gunshi.dev/api/default/type-aliases/DefaultGunshiParams)[`"extensions"`] | A type extending [GunshiParams](https://gunshi.dev/api/default/interfaces/GunshiParams) to specify the shape of [`CommandContext`](https://gunshi.dev/api/default/interfaces/CommandContext)'s extensions.  
ts```
...
Plugin return type without extension, which includes the plugin ID, name, and dependencies, but no extension.
This type is used to define a plugin at `plugin` function without extension.
## Parameters [​](https://gunshi.dev/api/default/interfaces/PluginWithoutExtension#parameters)
Parameter | Type  
---|---  
`ctx` |  `Readonly`<[`PluginContext`](https://gunshi.dev/api/default/interfaces/PluginContext)<`G`>>  
## Returns [​](https://gunshi.dev/api/default/interfaces/PluginWithoutExtension#returns)
[`Awaitable`](https://gunshi.dev/api/default/type-aliases/Awaitable)<`void`>
## Properties [​](https://gunshi.dev/api/default/interfaces/PluginWithoutExtension#properties)
Property | Type | Description | Overrides | Inherited from  
---|---|---|---|---  
`dependencies?` | (`string` | [`PluginDependency`](https://gunshi.dev/api/default/interfaces/PluginDependency))[] | Plugin dependencies | `Plugin.dependencies` | -  
`extension?` |  [`CommandContextExtension`](https://gunshi.dev/api/default/interfaces/CommandContextExtension)<`E`> | - | - | `Plugin.extension`  
`id` | `string` | Plugin identifier | `Plugin.id` | -  
`name` | `string` | Plugin name | `Plugin.name` | -  
Pager
[Previous pagePluginWithExtension](https://gunshi.dev/api/default/interfaces/PluginWithExtension)
[Next pageRenderingOptions](https://gunshi.dev/api/default/interfaces/RenderingOptions)
