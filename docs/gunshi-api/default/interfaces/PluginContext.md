[Skip to content](https://gunshi.dev/api/default/interfaces/PluginContext#VPContent)
...
On this page
  * [Since](https://gunshi.dev/api/default/interfaces/PluginContext#since "Since")
  * [Type Parameters](https://gunshi.dev/api/default/interfaces/PluginContext#type-parameters "Type Parameters")
  * [Methods](https://gunshi.dev/api/default/interfaces/PluginContext#methods "Methods")
  * [Properties](https://gunshi.dev/api/default/interfaces/PluginContext#properties "Properties")


Are you an LLM? You can read better optimized documentation at /api/default/interfaces/PluginContext.md for this page in Markdown format
[gunshi](https://gunshi.dev/api/) / [default](https://gunshi.dev/api/default/) / PluginContext
# Interface: PluginContext<G> [​](https://gunshi.dev/api/default/interfaces/PluginContext#interface-plugincontext-g)
Gunshi plugin context interface.
## Since [​](https://gunshi.dev/api/default/interfaces/PluginContext#since)
v0.27.0
## Type Parameters [​](https://gunshi.dev/api/default/interfaces/PluginContext#type-parameters)
Type Parameter | Default type | Description  
---|---|---  
`G` _extends_ [`GunshiParamsConstraint`](https://gunshi.dev/api/default/type-aliases/GunshiParamsConstraint) | [`DefaultGunshiParams`](https://gunshi.dev/api/default/type-aliases/DefaultGunshiParams) | A type extending [`GunshiParams`](https://gunshi.dev/api/default/interfaces/GunshiParams) to specify the shape of command parameters.  
## Methods [​](https://gunshi.dev/api/default/interfaces/PluginContext#methods)
### addCommand() [​](https://gunshi.dev/api/default/interfaces/PluginContext#addcommand)
ts```
addCommand(name, command): void;
```

Add a sub command.
#### Parameters [​](https://gunshi.dev/api/default/interfaces/PluginContext#parameters)
Parameter | Type | Description  
---|---|---  
`name` | `string` | Command name  
`command` | | [`Command`](https://gunshi.dev/api/default/interfaces/Command)<`G`> | [`LazyCommand`](https://gunshi.dev/api/default/type-aliases/LazyCommand)<`G`> | Command definition  
#### Returns [​](https://gunshi.dev/api/default/interfaces/PluginContext#returns)
`void`
* * *
### addGlobalOption() [​](https://gunshi.dev/api/default/interfaces/PluginContext#addglobaloption)
ts```
addGlobalOption(name, schema): void;
```

Add a global option.
#### Parameters [​](https://gunshi.dev/api/default/interfaces/PluginContext#parameters-1)
Parameter | Type | Description  
---|---|---  
`name` | `string` | An option name  
`schema` | [`ArgSchema`](https://gunshi.dev/api/default/interfaces/ArgSchema) | An [`ArgSchema`](https://gunshi.dev/api/default/interfaces/ArgSchema) for the option  
#### Returns [​](https://gunshi.dev/api/default/interfaces/PluginContext#returns-1)
`void`
* * *
### decorateCommand() [​](https://gunshi.dev/api/default/interfaces/PluginContext#decoratecommand)
ts```
...
#### Type Parameters [​](https://gunshi.dev/api/default/interfaces/PluginContext#type-parameters-1)
Type Parameter | Default type | Description  
---|---|---  
`L` _extends_ `Record`<`string`, `unknown`> | `object` | An extensions type to specify the shape of [`CommandContext`](https://gunshi.dev/api/default/interfaces/CommandContext)'s extensions.  
#### Parameters [​](https://gunshi.dev/api/default/interfaces/PluginContext#parameters-2)
Parameter | Type | Description  
---|---|---  
`decorator` | (`baseRunner`) => (`ctx`) => [`Awaitable`](https://gunshi.dev/api/default/type-aliases/Awaitable)<`string` | `void`> | A decorator function that wraps the command runner  
#### Returns [​](https://gunshi.dev/api/default/interfaces/PluginContext#returns-2)
`void`
* * *
### decorateHeaderRenderer() [​](https://gunshi.dev/api/default/interfaces/PluginContext#decorateheaderrenderer)
ts```
decorateHeaderRenderer<L>(decorator): void;
```

Decorate the header renderer.
#### Type Parameters [​](https://gunshi.dev/api/default/interfaces/PluginContext#type-parameters-2)
Type Parameter | Default type | Description  
---|---|---  
`L` _extends_ `Record`<`string`, `unknown`> | `object` | An extensions type to specify the shape of [`CommandContext`](https://gunshi.dev/api/default/interfaces/CommandContext)'s extensions.  
#### Parameters [​](https://gunshi.dev/api/default/interfaces/PluginContext#parameters-3)
Parameter | Type | Description  
---|---|---  
`decorator` | (`baseRenderer`, `ctx`) => `Promise`<`string`> | A decorator function that wraps the base header renderer.  
#### Returns [​](https://gunshi.dev/api/default/interfaces/PluginContext#returns-3)
`void`
* * *
### decorateUsageRenderer() [​](https://gunshi.dev/api/default/interfaces/PluginContext#decorateusagerenderer)
ts```
decorateUsageRenderer<L>(decorator): void;
```

Decorate the usage renderer.
#### Type Parameters [​](https://gunshi.dev/api/default/interfaces/PluginContext#type-parameters-3)
Type Parameter | Default type | Description  
---|---|---  
`L` _extends_ `Record`<`string`, `unknown`> | `object` | An extensions type to specify the shape of [`CommandContext`](https://gunshi.dev/api/default/interfaces/CommandContext)'s extensions.  
#### Parameters [​](https://gunshi.dev/api/default/interfaces/PluginContext#parameters-4)
Parameter | Type | Description  
---|---|---  
`decorator` | (`baseRenderer`, `ctx`) => `Promise`<`string`> | A decorator function that wraps the base usage renderer.  
#### Returns [​](https://gunshi.dev/api/default/interfaces/PluginContext#returns-4)
`void`
* * *
### decorateValidationErrorsRenderer() [​](https://gunshi.dev/api/default/interfaces/PluginContext#decoratevalidationerrorsrenderer)
ts```
decorateValidationErrorsRenderer<L>(decorator): void;
```

Decorate the validation errors renderer.
#### Type Parameters [​](https://gunshi.dev/api/default/interfaces/PluginContext#type-parameters-4)
Type Parameter | Default type | Description  
---|---|---  
`L` _extends_ `Record`<`string`, `unknown`> | `object` | An extensions type to specify the shape of [`CommandContext`](https://gunshi.dev/api/default/interfaces/CommandContext)'s extensions.  
#### Parameters [​](https://gunshi.dev/api/default/interfaces/PluginContext#parameters-5)
Parameter | Type | Description  
---|---|---  
`decorator` | (`baseRenderer`, `ctx`, `error`) => `Promise`<`string`> | A decorator function that wraps the base validation errors renderer.  
#### Returns [​](https://gunshi.dev/api/default/interfaces/PluginContext#returns-5)
`void`
* * *
### hasCommand() [​](https://gunshi.dev/api/default/interfaces/PluginContext#hascommand)
ts```
hasCommand(name): boolean;
```

Check if a command exists.
#### Parameters [​](https://gunshi.dev/api/default/interfaces/PluginContext#parameters-6)
Parameter | Type | Description  
---|---|---  
`name` | `string` | Command name  
#### Returns [​](https://gunshi.dev/api/default/interfaces/PluginContext#returns-6)
`boolean`
True if the command exists, false otherwise
## Properties [​](https://gunshi.dev/api/default/interfaces/PluginContext#properties)
Property | Modifier | Type | Description  
---|---|---|---  
`globalOptions` | `readonly` |  `Map`<`string`, [`ArgSchema`](https://gunshi.dev/api/default/interfaces/ArgSchema)> | Get the global options  
`subCommands` | `readonly` |  `ReadonlyMap`<`string`, | [`Command`](https://gunshi.dev/api/default/interfaces/Command)<`G`> | [`LazyCommand`](https://gunshi.dev/api/default/type-aliases/LazyCommand)<`G`>> | Get the registered sub commands  
Pager
[Previous pageGunshiParams](https://gunshi.dev/api/default/interfaces/GunshiParams)
[Next pagePluginDependency](https://gunshi.dev/api/default/interfaces/PluginDependency)
