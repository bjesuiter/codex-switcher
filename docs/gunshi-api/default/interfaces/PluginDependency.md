[Skip to content](https://gunshi.dev/api/default/interfaces/PluginDependency#VPContent)
...
On this page
  * [Since](https://gunshi.dev/api/default/interfaces/PluginDependency#since "Since")
  * [Properties](https://gunshi.dev/api/default/interfaces/PluginDependency#properties "Properties")


Are you an LLM? You can read better optimized documentation at /api/default/interfaces/PluginDependency.md for this page in Markdown format
[gunshi](https://gunshi.dev/api/) / [default](https://gunshi.dev/api/default/) / PluginDependency
# Interface: PluginDependency [​](https://gunshi.dev/api/default/interfaces/PluginDependency#interface-plugindependency)
Plugin dependency definition
## Since [​](https://gunshi.dev/api/default/interfaces/PluginDependency#since)
v0.27.0
## Properties [​](https://gunshi.dev/api/default/interfaces/PluginDependency#properties)
...
Pager
[Previous pagePluginContext](https://gunshi.dev/api/default/interfaces/PluginContext)
[Next pagePluginOptions](https://gunshi.dev/api/default/interfaces/PluginOptions)
