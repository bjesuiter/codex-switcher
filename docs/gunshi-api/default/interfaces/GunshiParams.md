[Skip to content](https://gunshi.dev/api/default/interfaces/GunshiParams#VPContent)
...
On this page
  * [Since](https://gunshi.dev/api/default/interfaces/GunshiParams#since "Since")
  * [Type Parameters](https://gunshi.dev/api/default/interfaces/GunshiParams#type-parameters "Type Parameters")
  * [Properties](https://gunshi.dev/api/default/interfaces/GunshiParams#properties "Properties")


Are you an LLM? You can read better optimized documentation at /api/default/interfaces/GunshiParams.md for this page in Markdown format
[gunshi](https://gunshi.dev/api/) / [default](https://gunshi.dev/api/default/) / GunshiParams
# Interface: GunshiParams<P> [​](https://gunshi.dev/api/default/interfaces/GunshiParams#interface-gunshiparams-p)
Gunshi unified parameter type.
This type combines both argument definitions and command context extensions.
## Since [​](https://gunshi.dev/api/default/interfaces/GunshiParams#since)
v0.27.0
## Type Parameters [​](https://gunshi.dev/api/default/interfaces/GunshiParams#type-parameters)
Type Parameter | Default type | Description  
---|---|---  
`P` _extends_ `object` | `object` | The type of parameters, which can include `args` and `extensions`.  
## Properties [​](https://gunshi.dev/api/default/interfaces/GunshiParams#properties)
Property | Type | Description  
---|---|---  
`args` |  `P` _extends_ `object` ? `A` : [`Args`](https://gunshi.dev/api/default/interfaces/Args) | Command argument definitions.  
`extensions` |  `P` _extends_ `object` ? `E` : `object` | Command context extensions.  
Pager
[Previous pageCommandEnvironment](https://gunshi.dev/api/default/interfaces/CommandEnvironment)
[Next pagePluginContext](https://gunshi.dev/api/default/interfaces/PluginContext)
