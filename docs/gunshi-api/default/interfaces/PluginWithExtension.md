[Skip to content](https://gunshi.dev/api/default/interfaces/PluginWithExtension#VPContent)
...
On this page
  * [Extends](https://gunshi.dev/api/default/interfaces/PluginWithExtension#extends "Extends")
  * [Type Parameters](https://gunshi.dev/api/default/interfaces/PluginWithExtension#type-parameters "Type Parameters")
  * [Parameters](https://gunshi.dev/api/default/interfaces/PluginWithExtension#parameters "Parameters")
  * [Returns](https://gunshi.dev/api/default/interfaces/PluginWithExtension#returns "Returns")
  * [Properties](https://gunshi.dev/api/default/interfaces/PluginWithExtension#properties "Properties")


Are you an LLM? You can read better optimized documentation at /api/default/interfaces/PluginWithExtension.md for this page in Markdown format
[gunshi](https://gunshi.dev/api/) / [default](https://gunshi.dev/api/default/) / PluginWithExtension
# Interface: PluginWithExtension()<E> [​](https://gunshi.dev/api/default/interfaces/PluginWithExtension#interface-pluginwithextension-e)
...
## Extends [​](https://gunshi.dev/api/default/interfaces/PluginWithExtension#extends)
  * [`Plugin`](https://gunshi.dev/api/default/type-aliases/Plugin)<`E`>


## Type Parameters [​](https://gunshi.dev/api/default/interfaces/PluginWithExtension#type-parameters)
...
Plugin return type with extension, which includes the plugin ID, name, dependencies, and extension.
This type is used to define a plugin at `plugin` function.
## Parameters [​](https://gunshi.dev/api/default/interfaces/PluginWithExtension#parameters)
Parameter | Type  
---|---  
`ctx` |  `Readonly`<[`PluginContext`](https://gunshi.dev/api/default/interfaces/PluginContext)<`G`>>  
## Returns [​](https://gunshi.dev/api/default/interfaces/PluginWithExtension#returns)
[`Awaitable`](https://gunshi.dev/api/default/type-aliases/Awaitable)<`void`>
## Properties [​](https://gunshi.dev/api/default/interfaces/PluginWithExtension#properties)
...
`extension` |  [`CommandContextExtension`](https://gunshi.dev/api/default/interfaces/CommandContextExtension)<`E`> | Plugin extension | `Plugin.extension`  
`id` | `string` | Plugin identifier | `Plugin.id`  
`name` | `string` | Plugin name | `Plugin.name`  
Pager
[Previous pagePluginOptions](https://gunshi.dev/api/default/interfaces/PluginOptions)
[Next pagePluginWithoutExtension](https://gunshi.dev/api/default/interfaces/PluginWithoutExtension)
