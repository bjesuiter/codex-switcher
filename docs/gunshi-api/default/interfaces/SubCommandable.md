[Skip to content](https://gunshi.dev/api/default/interfaces/SubCommandable#VPContent)
...
On this page
  * [Since](https://gunshi.dev/api/default/interfaces/SubCommandable#since "Since")
  * [Indexable](https://gunshi.dev/api/default/interfaces/SubCommandable#indexable "Indexable")
  * [Properties](https://gunshi.dev/api/default/interfaces/SubCommandable#properties "Properties")


Are you an LLM? You can read better optimized documentation at /api/default/interfaces/SubCommandable.md for this page in Markdown format
[gunshi](https://gunshi.dev/api/) / [default](https://gunshi.dev/api/default/) / SubCommandable
# Interface: SubCommandable [​](https://gunshi.dev/api/default/interfaces/SubCommandable#interface-subcommandable)
...
## Since [​](https://gunshi.dev/api/default/interfaces/SubCommandable#since)
v0.27.1
## Indexable [​](https://gunshi.dev/api/default/interfaces/SubCommandable#indexable)
ts```
[key: string]: any
```

Index signature to allow additional properties
## Properties [​](https://gunshi.dev/api/default/interfaces/SubCommandable#properties)
Property | Type | Description  
---|---|---  
`args?` |  [`Args`](https://gunshi.dev/api/default/interfaces/Args) | `Record`<`string`, `any`> | see [Command.args](https://gunshi.dev/api/default/interfaces/Command#args)  
`commandName?` | `string` | see LazyCommand.commandName  
`description?` | `string` | see [Command.description](https://gunshi.dev/api/default/interfaces/Command#description)  
`entry?` | `boolean` | see [Command.entry](https://gunshi.dev/api/default/interfaces/Command#entry)  
`examples?` |  `string` | (...`args`) => `any` | see [Command.examples](https://gunshi.dev/api/default/interfaces/Command#examples)  
`internal?` | `boolean` | see [Command.internal](https://gunshi.dev/api/default/interfaces/Command#internal)  
`name?` | `string` | see [Command.name](https://gunshi.dev/api/default/interfaces/Command#name)  
`rendering?` | `any` | see [Command.rendering](https://gunshi.dev/api/default/interfaces/Command#rendering)  
`run?` | (...`args`) => `any` | see [Command.run](https://gunshi.dev/api/default/interfaces/Command#run)  
`subCommands?` |  `Record`<`string`, `any`> | `Map`<`string`, `any`> | Nested sub-commands for this command. **See** [Command.subCommands](https://gunshi.dev/api/default/interfaces/Command#subcommands) **Since** v0.28.0  
`toKebab?` | `boolean` | see [Command.toKebab](https://gunshi.dev/api/default/interfaces/Command#tokebab)  
Pager
[Previous pageRenderingOptions](https://gunshi.dev/api/default/interfaces/RenderingOptions)
[Next pageArgValues](https://gunshi.dev/api/default/type-aliases/ArgValues)
