[Skip to content](https://gunshi.dev/api/default/functions/plugin#VPContent)
...
On this page
  * [Param](https://gunshi.dev/api/default/functions/plugin#param "Param")
  * [Since](https://gunshi.dev/api/default/functions/plugin#since "Since")
  * [Call Signature](https://gunshi.dev/api/default/functions/plugin#call-signature "Call Signature")
  * [Call Signature](https://gunshi.dev/api/default/functions/plugin#call-signature-1 "Call Signature")


Are you an LLM? You can read better optimized documentation at /api/default/functions/plugin.md for this page in Markdown format
[gunshi](https://gunshi.dev/api/) / [default](https://gunshi.dev/api/default/) / plugin
# Function: plugin() [​](https://gunshi.dev/api/default/functions/plugin#function-plugin)
Define a plugin
## Param [​](https://gunshi.dev/api/default/functions/plugin#param)
[`plugin options`](https://gunshi.dev/api/default/interfaces/PluginOptions)
## Since [​](https://gunshi.dev/api/default/functions/plugin#since)
v0.27.0
## Call Signature [​](https://gunshi.dev/api/default/functions/plugin#call-signature)
ts```
...
### Type Parameters [​](https://gunshi.dev/api/default/functions/plugin#type-parameters)
Type Parameter | Default type | Description  
---|---|---  
`Context` _extends_ [`ExtendContext`](https://gunshi.dev/api/default/type-aliases/ExtendContext) | `object` | A type extending [`ExtendContext`](https://gunshi.dev/api/default/type-aliases/ExtendContext) to specify the shape of plugin dependency extensions.  
`Id` _extends_ `string` | `string` | A string type to specify the plugin ID.  
`Deps` _extends_ readonly (`string` | [`PluginDependency`](https://gunshi.dev/api/default/interfaces/PluginDependency))[] | [] | A readonly array of [`PluginDependency`](https://gunshi.dev/api/default/interfaces/PluginDependency) or string to specify the plugin dependencies.  
`Extension` _extends_ `object` | `object` | A type to specify the shape of the plugin extension object.  
`ResolvedDepExtensions` _extends_ [`GunshiParams`](https://gunshi.dev/api/default/interfaces/GunshiParams)<{ `args`: [`Args`](https://gunshi.dev/api/default/interfaces/Args); `extensions`: { }; }> |  [`GunshiParams`](https://gunshi.dev/api/default/interfaces/GunshiParams)<{ `args`: [`Args`](https://gunshi.dev/api/default/interfaces/Args); `extensions`: `InferDependencyExtensions`<`Deps`, `Context`>; }> | -  
`PluginExt` _extends_ [`PluginExtension`](https://gunshi.dev/api/default/type-aliases/PluginExtension)<`Extension`, [`DefaultGunshiParams`](https://gunshi.dev/api/default/type-aliases/DefaultGunshiParams)> |  [`PluginExtension`](https://gunshi.dev/api/default/type-aliases/PluginExtension)<`Extension`, `ResolvedDepExtensions`> | -  
`MergedExtensions` _extends_ [`GunshiParams`](https://gunshi.dev/api/default/interfaces/GunshiParams)<{ `args`: [`Args`](https://gunshi.dev/api/default/interfaces/Args); `extensions`: { }; }> |  [`GunshiParams`](https://gunshi.dev/api/default/interfaces/GunshiParams)<{ `args`: [`Args`](https://gunshi.dev/api/default/interfaces/Args); `extensions`: `MergeExtension`<`Id`, `InferDependencyExtensions`<`Deps`, `Context`>, `Awaited`<`ReturnType`<`PluginExt`>>>; }> | -  
### Parameters [​](https://gunshi.dev/api/default/functions/plugin#parameters)
Parameter | Type | Description  
---|---|---  
`options` | { `dependencies?`: `Deps`; `extension`: `PluginExt`; `id`: `Id`; `name?`: `string`; `onExtension?`: [`OnPluginExtension`](https://gunshi.dev/api/default/type-aliases/OnPluginExtension)<`MergedExtensions`>; `setup?`: (`ctx`) => [`Awaitable`](https://gunshi.dev/api/default/type-aliases/Awaitable)<`void`>; } | [`plugin options`](https://gunshi.dev/api/default/interfaces/PluginOptions)  
`options.dependencies?` | `Deps` | -  
`options.extension` | `PluginExt` | -  
`options.id` | `Id` | -  
`options.name?` | `string` | -  
`options.onExtension?` |  [`OnPluginExtension`](https://gunshi.dev/api/default/type-aliases/OnPluginExtension)<`MergedExtensions`> | -  
`options.setup?` | (`ctx`) => [`Awaitable`](https://gunshi.dev/api/default/type-aliases/Awaitable)<`void`> | -  
### Returns [​](https://gunshi.dev/api/default/functions/plugin#returns)
[`PluginWithExtension`](https://gunshi.dev/api/default/interfaces/PluginWithExtension)<`Awaited`<`ReturnType`<`PluginExt`>>>
A defined plugin with extension
### Since [​](https://gunshi.dev/api/default/functions/plugin#since-1)
v0.27.0
## Call Signature [​](https://gunshi.dev/api/default/functions/plugin#call-signature-1)
ts```
...
### Type Parameters [​](https://gunshi.dev/api/default/functions/plugin#type-parameters-1)
Type Parameter | Default type | Description  
---|---|---  
`Context` _extends_ [`ExtendContext`](https://gunshi.dev/api/default/type-aliases/ExtendContext) | `object` | A type extending [`ExtendContext`](https://gunshi.dev/api/default/type-aliases/ExtendContext) to specify the shape of plugin dependency extensions.  
`Id` _extends_ `string` | `string` | A string type to specify the plugin ID.  
`Deps` _extends_ readonly (`string` | [`PluginDependency`](https://gunshi.dev/api/default/interfaces/PluginDependency))[] | [] | A readonly array of [`PluginDependency`](https://gunshi.dev/api/default/interfaces/PluginDependency) or string to specify the plugin dependencies.  
`Extension` _extends_ `Record`<`string`, `unknown`> | `object` | A type to specify the shape of the plugin extension object.  
`ResolvedDepExtensions` _extends_ [`GunshiParams`](https://gunshi.dev/api/default/interfaces/GunshiParams)<{ `args`: [`Args`](https://gunshi.dev/api/default/interfaces/Args); `extensions`: { }; }> |  [`GunshiParams`](https://gunshi.dev/api/default/interfaces/GunshiParams)<{ `args`: [`Args`](https://gunshi.dev/api/default/interfaces/Args); `extensions`: `InferDependencyExtensions`<`Deps`, `Context`>; }> | -  
`PluginExt` _extends_ [`PluginExtension`](https://gunshi.dev/api/default/type-aliases/PluginExtension)<`Extension`, [`DefaultGunshiParams`](https://gunshi.dev/api/default/type-aliases/DefaultGunshiParams)> |  [`PluginExtension`](https://gunshi.dev/api/default/type-aliases/PluginExtension)<`Extension`, `ResolvedDepExtensions`> | -  
`MergedExtensions` _extends_ [`GunshiParams`](https://gunshi.dev/api/default/interfaces/GunshiParams)<{ `args`: [`Args`](https://gunshi.dev/api/default/interfaces/Args); `extensions`: { }; }> |  [`GunshiParams`](https://gunshi.dev/api/default/interfaces/GunshiParams)<{ `args`: [`Args`](https://gunshi.dev/api/default/interfaces/Args); `extensions`: `MergeExtension`<`Id`, `InferDependencyExtensions`<`Deps`, `Context`>, `Awaited`<`ReturnType`<`PluginExt`>>>; }> | -  
### Parameters [​](https://gunshi.dev/api/default/functions/plugin#parameters-1)
Parameter | Type | Description  
---|---|---  
`options` | { `dependencies?`: `Deps`; `id`: `Id`; `name?`: `string`; `onExtension?`: [`OnPluginExtension`](https://gunshi.dev/api/default/type-aliases/OnPluginExtension)<`MergedExtensions`>; `setup?`: (`ctx`) => [`Awaitable`](https://gunshi.dev/api/default/type-aliases/Awaitable)<`void`>; } |  [`plugin options`](https://gunshi.dev/api/default/interfaces/PluginOptions) without extension  
`options.dependencies?` | `Deps` | -  
`options.id` | `Id` | -  
`options.name?` | `string` | -  
`options.onExtension?` |  [`OnPluginExtension`](https://gunshi.dev/api/default/type-aliases/OnPluginExtension)<`MergedExtensions`> | -  
`options.setup?` | (`ctx`) => [`Awaitable`](https://gunshi.dev/api/default/type-aliases/Awaitable)<`void`> | -  
### Returns [​](https://gunshi.dev/api/default/functions/plugin#returns-1)
[`PluginWithoutExtension`](https://gunshi.dev/api/default/interfaces/PluginWithoutExtension)<{ }>
A defined plugin without extension
### Since [​](https://gunshi.dev/api/default/functions/plugin#since-2)
v0.27.0
Pager
[Previous pageparseArgs](https://gunshi.dev/api/default/functions/parseArgs)
[Next pageresolveArgs](https://gunshi.dev/api/default/functions/resolveArgs)
