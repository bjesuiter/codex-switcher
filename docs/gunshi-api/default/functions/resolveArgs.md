[Skip to content](https://gunshi.dev/api/default/functions/resolveArgs#VPContent)
...
On this page
  * [Type Parameters](https://gunshi.dev/api/default/functions/resolveArgs#type-parameters "Type Parameters")
  * [Parameters](https://gunshi.dev/api/default/functions/resolveArgs#parameters "Parameters")
  * [Returns](https://gunshi.dev/api/default/functions/resolveArgs#returns "Returns")
  * [Example](https://gunshi.dev/api/default/functions/resolveArgs#example "Example")


Are you an LLM? You can read better optimized documentation at /api/default/functions/resolveArgs.md for this page in Markdown format
[gunshi](https://gunshi.dev/api/) / [default](https://gunshi.dev/api/default/) / resolveArgs
# Function: resolveArgs() [​](https://gunshi.dev/api/default/functions/resolveArgs#function-resolveargs)
ts```
...
## Type Parameters [​](https://gunshi.dev/api/default/functions/resolveArgs#type-parameters)
Type Parameter | Description  
---|---  
`A` _extends_ [`Args`](https://gunshi.dev/api/default/interfaces/Args) |  [Arguments](https://gunshi.dev/api/default/interfaces/Args), which is an object that defines the command line arguments.  
## Parameters [​](https://gunshi.dev/api/default/functions/resolveArgs#parameters)
Parameter | Type | Description  
---|---|---  
`args` | `A` | An arguments that contains [arguments schema](https://gunshi.dev/api/default/interfaces/ArgSchema).  
`tokens` |  [`ArgToken`](https://gunshi.dev/api/default/interfaces/ArgToken)[] | An array of [tokens](https://gunshi.dev/api/default/interfaces/ArgToken).  
`resolveArgs?` | `ResolveArgs` | An arguments that contains ResolveArgs | resolve arguments.  
## Returns [​](https://gunshi.dev/api/default/functions/resolveArgs#returns)
`object`
...
### error [​](https://gunshi.dev/api/default/functions/resolveArgs#error)
ts```
error: AggregateError | undefined;
```

### explicit [​](https://gunshi.dev/api/default/functions/resolveArgs#explicit)
ts```
explicit: ArgExplicitlyProvided<A>;
```

### positionals [​](https://gunshi.dev/api/default/functions/resolveArgs#positionals)
ts```
positionals: string[];
```

### rest [​](https://gunshi.dev/api/default/functions/resolveArgs#rest)
ts```
rest: string[];
```

### values [​](https://gunshi.dev/api/default/functions/resolveArgs#values)
ts```
values: ArgValues<A>;
```

## Example [​](https://gunshi.dev/api/default/functions/resolveArgs#example)
typescript```
...
Pager
[Previous pageplugin](https://gunshi.dev/api/default/functions/plugin)
[Next pageDefaultTranslation](https://gunshi.dev/api/default/classes/DefaultTranslation)
