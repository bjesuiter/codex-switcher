[Skip to content](https://gunshi.dev/api/default/type-aliases/PluginExtension#VPContent)
...
On this page
  * [Type Parameters](https://gunshi.dev/api/default/type-aliases/PluginExtension#type-parameters "Type Parameters")
  * [Parameters](https://gunshi.dev/api/default/type-aliases/PluginExtension#parameters "Parameters")
  * [Returns](https://gunshi.dev/api/default/type-aliases/PluginExtension#returns "Returns")
  * [Since](https://gunshi.dev/api/default/type-aliases/PluginExtension#since "Since")


Are you an LLM? You can read better optimized documentation at /api/default/type-aliases/PluginExtension.md for this page in Markdown format
[gunshi](https://gunshi.dev/api/) / [default](https://gunshi.dev/api/default/) / PluginExtension
# Type Alias: PluginExtension()<T, G> [​](https://gunshi.dev/api/default/type-aliases/PluginExtension#type-alias-pluginextension-t-g)
ts```
type PluginExtension<T, G> = (ctx, cmd) => Awaitable<T>;
```

Plugin extension
## Type Parameters [​](https://gunshi.dev/api/default/type-aliases/PluginExtension#type-parameters)
Type Parameter | Default type | Description  
---|---|---  
`T` |  `Record`<`string`, `unknown`> | The type of the extension object returned by the plugin extension function.  
`G` _extends_ [`GunshiParams`](https://gunshi.dev/api/default/interfaces/GunshiParams) | [`DefaultGunshiParams`](https://gunshi.dev/api/default/type-aliases/DefaultGunshiParams) | A type extending [`GunshiParams`](https://gunshi.dev/api/default/interfaces/GunshiParams) to specify the shape of [`CommandContextCore`](https://gunshi.dev/api/default/type-aliases/CommandContextCore).  
## Parameters [​](https://gunshi.dev/api/default/type-aliases/PluginExtension#parameters)
Parameter | Type | Description  
---|---|---  
`ctx` |  [`CommandContextCore`](https://gunshi.dev/api/default/type-aliases/CommandContextCore)<`G`> | The [`command context`](https://gunshi.dev/api/default/type-aliases/CommandContextCore) core  
`cmd` |  [`Command`](https://gunshi.dev/api/default/interfaces/Command)<`G`> | The [`command`](https://gunshi.dev/api/default/interfaces/Command) to which the plugin is being applied  
## Returns [​](https://gunshi.dev/api/default/type-aliases/PluginExtension#returns)
[`Awaitable`](https://gunshi.dev/api/default/type-aliases/Awaitable)<`T`>
An object of type T that represents the extension provided by the plugin
## Since [​](https://gunshi.dev/api/default/type-aliases/PluginExtension#since)
v0.27.0
Pager
[Previous pagePlugin](https://gunshi.dev/api/default/type-aliases/Plugin)
[Next pagePluginFunction](https://gunshi.dev/api/default/type-aliases/PluginFunction)
