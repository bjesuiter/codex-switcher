[Skip to content](https://gunshi.dev/api/default/type-aliases/CommandDecorator#VPContent)
...
On this page
  * [Type Parameters](https://gunshi.dev/api/default/type-aliases/CommandDecorator#type-parameters "Type Parameters")
  * [Parameters](https://gunshi.dev/api/default/type-aliases/CommandDecorator#parameters "Parameters")
  * [Returns](https://gunshi.dev/api/default/type-aliases/CommandDecorator#returns "Returns")
  * [Since](https://gunshi.dev/api/default/type-aliases/CommandDecorator#since "Since")


Are you an LLM? You can read better optimized documentation at /api/default/type-aliases/CommandDecorator.md for this page in Markdown format
[gunshi](https://gunshi.dev/api/) / [default](https://gunshi.dev/api/default/) / CommandDecorator
# Type Alias: CommandDecorator()<G> [​](https://gunshi.dev/api/default/type-aliases/CommandDecorator#type-alias-commanddecorator-g)
ts```
...
## Type Parameters [​](https://gunshi.dev/api/default/type-aliases/CommandDecorator#type-parameters)
Type Parameter | Default type | Description  
---|---|---  
`G` _extends_ [`GunshiParamsConstraint`](https://gunshi.dev/api/default/type-aliases/GunshiParamsConstraint) | [`DefaultGunshiParams`](https://gunshi.dev/api/default/type-aliases/DefaultGunshiParams) | A type extending [`GunshiParams`](https://gunshi.dev/api/default/interfaces/GunshiParams) to specify the shape of command context.  
## Parameters [​](https://gunshi.dev/api/default/type-aliases/CommandDecorator#parameters)
Parameter | Type | Description  
---|---|---  
`baseRunner` | (`ctx`) => [`Awaitable`](https://gunshi.dev/api/default/type-aliases/Awaitable)<`string` | `void`> | The base command runner to decorate  
## Returns [​](https://gunshi.dev/api/default/type-aliases/CommandDecorator#returns)
The decorated command runner
ts```
(ctx): Awaitable<string | void>;
```

### Parameters [​](https://gunshi.dev/api/default/type-aliases/CommandDecorator#parameters-1)
Parameter | Type  
---|---  
`ctx` |  `Readonly`<[`CommandContext`](https://gunshi.dev/api/default/interfaces/CommandContext)<`G`>>  
### Returns [​](https://gunshi.dev/api/default/type-aliases/CommandDecorator#returns-1)
[`Awaitable`](https://gunshi.dev/api/default/type-aliases/Awaitable)<`string` | `void`>
## Since [​](https://gunshi.dev/api/default/type-aliases/CommandDecorator#since)
v0.27.0
Pager
[Previous pageCommandContextCore](https://gunshi.dev/api/default/type-aliases/CommandContextCore)
[Next pageCommandExamplesFetcher](https://gunshi.dev/api/default/type-aliases/CommandExamplesFetcher)
