[Skip to content](https://gunshi.dev/api/default/type-aliases/Plugin#VPContent)
...
On this page
  * [Type Declaration](https://gunshi.dev/api/default/type-aliases/Plugin#type-declaration "Type Declaration")
  * [Type Parameters](https://gunshi.dev/api/default/type-aliases/Plugin#type-parameters "Type Parameters")
  * [Param](https://gunshi.dev/api/default/type-aliases/Plugin#param "Param")
  * [Returns](https://gunshi.dev/api/default/type-aliases/Plugin#returns "Returns")
  * [Since](https://gunshi.dev/api/default/type-aliases/Plugin#since "Since")


Are you an LLM? You can read better optimized documentation at /api/default/type-aliases/Plugin.md for this page in Markdown format
[gunshi](https://gunshi.dev/api/) / [default](https://gunshi.dev/api/default/) / Plugin
# Type Alias: Plugin<E> [​](https://gunshi.dev/api/default/type-aliases/Plugin#type-alias-plugin-e)
ts```
type Plugin<E> = PluginFunction & object;
```

Gunshi plugin, which is a function that receives a PluginContext.
## Type Declaration [​](https://gunshi.dev/api/default/type-aliases/Plugin#type-declaration)
### dependencies? [​](https://gunshi.dev/api/default/type-aliases/Plugin#dependencies)
ts```
optional dependencies: (PluginDependency | string)[];
```

### extension? [​](https://gunshi.dev/api/default/type-aliases/Plugin#extension)
ts```
optional extension: CommandContextExtension<E>;
```

### id [​](https://gunshi.dev/api/default/type-aliases/Plugin#id)
ts```
id: string;
```

### name? [​](https://gunshi.dev/api/default/type-aliases/Plugin#name)
ts```
optional name: string;
```

## Type Parameters [​](https://gunshi.dev/api/default/type-aliases/Plugin#type-parameters)
...
## Param [​](https://gunshi.dev/api/default/type-aliases/Plugin#param)
A [`PluginContext`](https://gunshi.dev/api/default/interfaces/PluginContext).
## Returns [​](https://gunshi.dev/api/default/type-aliases/Plugin#returns)
An [`Awaitable`](https://gunshi.dev/api/default/type-aliases/Awaitable) that resolves when the plugin is loaded.
## Since [​](https://gunshi.dev/api/default/type-aliases/Plugin#since)
v0.27.0
Pager
[Previous pageOnPluginExtension](https://gunshi.dev/api/default/type-aliases/OnPluginExtension)
[Next pagePluginExtension](https://gunshi.dev/api/default/type-aliases/PluginExtension)
