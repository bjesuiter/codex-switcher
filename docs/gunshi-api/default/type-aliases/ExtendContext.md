[Skip to content](https://gunshi.dev/api/default/type-aliases/ExtendContext#VPContent)
...
On this page
  * [Since](https://gunshi.dev/api/default/type-aliases/ExtendContext#since "Since")


Are you an LLM? You can read better optimized documentation at /api/default/type-aliases/ExtendContext.md for this page in Markdown format
[gunshi](https://gunshi.dev/api/) / [default](https://gunshi.dev/api/default/) / ExtendContext
# Type Alias: ExtendContext [​](https://gunshi.dev/api/default/type-aliases/ExtendContext#type-alias-extendcontext)
ts```
type ExtendContext = Record<string, unknown>;
```

Extend command context type. This type is used to extend the command context with additional properties at [`CommandContext.extensions`](https://gunshi.dev/api/default/interfaces/CommandContext#extensions).
## Since [​](https://gunshi.dev/api/default/type-aliases/ExtendContext#since)
v0.27.0
Pager
[Previous pageDefaultGunshiParams](https://gunshi.dev/api/default/type-aliases/DefaultGunshiParams)
[Next pageGunshiParamsConstraint](https://gunshi.dev/api/default/type-aliases/GunshiParamsConstraint)
