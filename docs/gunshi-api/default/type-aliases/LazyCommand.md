[Skip to content](https://gunshi.dev/api/default/type-aliases/LazyCommand#VPContent)
...
On this page
  * [Type Parameters](https://gunshi.dev/api/default/type-aliases/LazyCommand#type-parameters "Type Parameters")


Are you an LLM? You can read better optimized documentation at /api/default/type-aliases/LazyCommand.md for this page in Markdown format
[gunshi](https://gunshi.dev/api/) / [default](https://gunshi.dev/api/default/) / LazyCommand
# Type Alias: LazyCommand<G, D> [​](https://gunshi.dev/api/default/type-aliases/LazyCommand#type-alias-lazycommand-g-d)
ts```
type LazyCommand<G, D> = () => Awaitable<
  | Command<G>
| CommandRunner<G>> & D extends object ? object : object & Omit<D, "name" | "run"> & Partial<Omit<Command<G>, keyof D | "run" | "name">>;
```

Lazy command interface.
Lazy command that's not loaded until it is executed.
## Type Parameters [​](https://gunshi.dev/api/default/type-aliases/LazyCommand#type-parameters)
...
`D` _extends_ `Partial`<[`Command`](https://gunshi.dev/api/default/interfaces/Command)<`G`>> | `object` | The partial command definition provided to lazy function  
Pager
[Previous pageGunshiParamsConstraint](https://gunshi.dev/api/default/type-aliases/GunshiParamsConstraint)
[Next pageOnPluginExtension](https://gunshi.dev/api/default/type-aliases/OnPluginExtension)
