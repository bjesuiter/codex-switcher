[Skip to content](https://gunshi.dev/api/default/type-aliases/ArgValues#VPContent)
...
On this page
  * [Type Parameters](https://gunshi.dev/api/default/type-aliases/ArgValues#type-parameters "Type Parameters")


Are you an LLM? You can read better optimized documentation at /api/default/type-aliases/ArgValues.md for this page in Markdown format
[gunshi](https://gunshi.dev/api/) / [default](https://gunshi.dev/api/default/) / ArgValues
# Type Alias: ArgValues<T> [​](https://gunshi.dev/api/default/type-aliases/ArgValues#type-alias-argvalues-t)
ts```
type ArgValues<T> = T extends Args ? ResolveArgValues<T, { [Arg in keyof T]: ExtractOptionValue<T[Arg]> }> : object;
```

An object that contains the values of the arguments.
## Type Parameters [​](https://gunshi.dev/api/default/type-aliases/ArgValues#type-parameters)
Type Parameter | Description  
---|---  
`T` |  [Arguments](https://gunshi.dev/api/default/interfaces/Args) which is an object that defines the command line arguments.  
Pager
[Previous pageSubCommandable](https://gunshi.dev/api/default/interfaces/SubCommandable)
[Next pageAwaitable](https://gunshi.dev/api/default/type-aliases/Awaitable)
