[Skip to content](https://gunshi.dev/api/default/type-aliases/CommandContextCore#VPContent)
...
On this page
  * [Type Parameters](https://gunshi.dev/api/default/type-aliases/CommandContextCore#type-parameters "Type Parameters")
  * [Since](https://gunshi.dev/api/default/type-aliases/CommandContextCore#since "Since")


Are you an LLM? You can read better optimized documentation at /api/default/type-aliases/CommandContextCore.md for this page in Markdown format
[gunshi](https://gunshi.dev/api/) / [default](https://gunshi.dev/api/default/) / CommandContextCore
# Type Alias: CommandContextCore<G> [​](https://gunshi.dev/api/default/type-aliases/CommandContextCore#type-alias-commandcontextcore-g)
ts```
type CommandContextCore<G> = Readonly<CommandContext<G>>;
```

CommandContextCore type (base type without extensions)
## Type Parameters [​](https://gunshi.dev/api/default/type-aliases/CommandContextCore#type-parameters)
...
## Since [​](https://gunshi.dev/api/default/type-aliases/CommandContextCore#since)
v0.27.0
Pager
[Previous pageCommandCallMode](https://gunshi.dev/api/default/type-aliases/CommandCallMode)
[Next pageCommandDecorator](https://gunshi.dev/api/default/type-aliases/CommandDecorator)
