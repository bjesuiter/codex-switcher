[Skip to content](https://gunshi.dev/api/default/type-aliases/OnPluginExtension#VPContent)
...
On this page
  * [Type Parameters](https://gunshi.dev/api/default/type-aliases/OnPluginExtension#type-parameters "Type Parameters")
  * [Parameters](https://gunshi.dev/api/default/type-aliases/OnPluginExtension#parameters "Parameters")
  * [Returns](https://gunshi.dev/api/default/type-aliases/OnPluginExtension#returns "Returns")
  * [Since](https://gunshi.dev/api/default/type-aliases/OnPluginExtension#since "Since")


Are you an LLM? You can read better optimized documentation at /api/default/type-aliases/OnPluginExtension.md for this page in Markdown format
[gunshi](https://gunshi.dev/api/) / [default](https://gunshi.dev/api/default/) / OnPluginExtension
# Type Alias: OnPluginExtension()<G> [​](https://gunshi.dev/api/default/type-aliases/OnPluginExtension#type-alias-onpluginextension-g)
ts```
...
## Type Parameters [​](https://gunshi.dev/api/default/type-aliases/OnPluginExtension#type-parameters)
Type Parameter | Default type | Description  
---|---|---  
`G` _extends_ [`GunshiParams`](https://gunshi.dev/api/default/interfaces/GunshiParams) | [`DefaultGunshiParams`](https://gunshi.dev/api/default/type-aliases/DefaultGunshiParams) | A type extending [`GunshiParams`](https://gunshi.dev/api/default/interfaces/GunshiParams) to specify the shape of [`CommandContext`](https://gunshi.dev/api/default/interfaces/CommandContext) and [`Command`](https://gunshi.dev/api/default/interfaces/Command).  
## Parameters [​](https://gunshi.dev/api/default/type-aliases/OnPluginExtension#parameters)
Parameter | Type | Description  
---|---|---  
`ctx` |  `Readonly`<[`CommandContext`](https://gunshi.dev/api/default/interfaces/CommandContext)<`G`>> | The [`command context`](https://gunshi.dev/api/default/interfaces/CommandContext)  
`cmd` |  `Readonly`<[`Command`](https://gunshi.dev/api/default/interfaces/Command)<`G`>> | The [`command`](https://gunshi.dev/api/default/interfaces/Command)  
## Returns [​](https://gunshi.dev/api/default/type-aliases/OnPluginExtension#returns)
[`Awaitable`](https://gunshi.dev/api/default/type-aliases/Awaitable)<`void`>
## Since [​](https://gunshi.dev/api/default/type-aliases/OnPluginExtension#since)
v0.27.0
Pager
[Previous pageLazyCommand](https://gunshi.dev/api/default/type-aliases/LazyCommand)
[Next pagePlugin](https://gunshi.dev/api/default/type-aliases/Plugin)
