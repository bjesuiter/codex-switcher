[Skip to content](https://gunshi.dev/api/default/type-aliases/DefaultGunshiParams#VPContent)
...
Are you an LLM? You can read better optimized documentation at /api/default/type-aliases/DefaultGunshiParams.md for this page in Markdown format
[gunshi](https://gunshi.dev/api/) / [default](https://gunshi.dev/api/default/) / DefaultGunshiParams
# Type Alias: DefaultGunshiParams [​](https://gunshi.dev/api/default/type-aliases/DefaultGunshiParams#type-alias-defaultgunshiparams)
ts```
type DefaultGunshiParams = GunshiParams;
```

Default Gunshi parameters.
## Since [​](https://gunshi.dev/api/default/type-aliases/DefaultGunshiParams#since)
v0.27.0
Pager
[Previous pageCommandRunner](https://gunshi.dev/api/default/type-aliases/CommandRunner)
[Next pageExtendContext](https://gunshi.dev/api/default/type-aliases/ExtendContext)
