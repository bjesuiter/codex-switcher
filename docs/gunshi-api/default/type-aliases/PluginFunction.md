[Skip to content](https://gunshi.dev/api/default/type-aliases/PluginFunction#VPContent)
...
On this page
  * [Type Parameters](https://gunshi.dev/api/default/type-aliases/PluginFunction#type-parameters "Type Parameters")
  * [Parameters](https://gunshi.dev/api/default/type-aliases/PluginFunction#parameters "Parameters")
  * [Returns](https://gunshi.dev/api/default/type-aliases/PluginFunction#returns "Returns")
  * [Since](https://gunshi.dev/api/default/type-aliases/PluginFunction#since "Since")


Are you an LLM? You can read better optimized documentation at /api/default/type-aliases/PluginFunction.md for this page in Markdown format
[gunshi](https://gunshi.dev/api/) / [default](https://gunshi.dev/api/default/) / PluginFunction
# Type Alias: PluginFunction()<G> [​](https://gunshi.dev/api/default/type-aliases/PluginFunction#type-alias-pluginfunction-g)
ts```
type PluginFunction<G> = (ctx) => Awaitable<void>;
```

Plugin function type
## Type Parameters [​](https://gunshi.dev/api/default/type-aliases/PluginFunction#type-parameters)
...
## Parameters [​](https://gunshi.dev/api/default/type-aliases/PluginFunction#parameters)
Parameter | Type  
---|---  
`ctx` |  `Readonly`<[`PluginContext`](https://gunshi.dev/api/default/interfaces/PluginContext)<`G`>>  
## Returns [​](https://gunshi.dev/api/default/type-aliases/PluginFunction#returns)
[`Awaitable`](https://gunshi.dev/api/default/type-aliases/Awaitable)<`void`>
## Since [​](https://gunshi.dev/api/default/type-aliases/PluginFunction#since)
v0.27.0
Pager
[Previous pagePluginExtension](https://gunshi.dev/api/default/type-aliases/PluginExtension)
[Next pagePrettify](https://gunshi.dev/api/default/type-aliases/Prettify)
