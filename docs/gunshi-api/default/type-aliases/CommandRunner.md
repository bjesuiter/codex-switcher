[Skip to content](https://gunshi.dev/api/default/type-aliases/CommandRunner#VPContent)
...
On this page
  * [Type Parameters](https://gunshi.dev/api/default/type-aliases/CommandRunner#type-parameters "Type Parameters")
  * [Parameters](https://gunshi.dev/api/default/type-aliases/CommandRunner#parameters "Parameters")
  * [Returns](https://gunshi.dev/api/default/type-aliases/CommandRunner#returns "Returns")


Are you an LLM? You can read better optimized documentation at /api/default/type-aliases/CommandRunner.md for this page in Markdown format
[gunshi](https://gunshi.dev/api/) / [default](https://gunshi.dev/api/default/) / CommandRunner
# Type Alias: CommandRunner()<G> [​](https://gunshi.dev/api/default/type-aliases/CommandRunner#type-alias-commandrunner-g)
ts```
type CommandRunner<G> = (ctx) => Awaitable<string | void>;
```

Command runner.
## Type Parameters [​](https://gunshi.dev/api/default/type-aliases/CommandRunner#type-parameters)
...
## Parameters [​](https://gunshi.dev/api/default/type-aliases/CommandRunner#parameters)
...
## Returns [​](https://gunshi.dev/api/default/type-aliases/CommandRunner#returns)
[`Awaitable`](https://gunshi.dev/api/default/type-aliases/Awaitable)<`string` | `void`>
void or string (for CLI output)
Pager
[Previous pageCommandLoader](https://gunshi.dev/api/default/type-aliases/CommandLoader)
[Next pageDefaultGunshiParams](https://gunshi.dev/api/default/type-aliases/DefaultGunshiParams)
