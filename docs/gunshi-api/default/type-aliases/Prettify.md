[Skip to content](https://gunshi.dev/api/default/type-aliases/Prettify#VPContent)
...
On this page
  * [Type Parameters](https://gunshi.dev/api/default/type-aliases/Prettify#type-parameters "Type Parameters")


Are you an LLM? You can read better optimized documentation at /api/default/type-aliases/Prettify.md for this page in Markdown format
[gunshi](https://gunshi.dev/api/) / [default](https://gunshi.dev/api/default/) / Prettify
# Type Alias: Prettify<T> [​](https://gunshi.dev/api/default/type-aliases/Prettify#type-alias-prettify-t)
ts```
type Prettify<T> = { [K in keyof T]: T[K] } & object;
```

Prettify a type by flattening its structure.
## Type Parameters [​](https://gunshi.dev/api/default/type-aliases/Prettify#type-parameters)
Type Parameter | Description  
---|---  
`T` | The type to be prettified.  
Pager
[Previous pagePluginFunction](https://gunshi.dev/api/default/type-aliases/PluginFunction)
[Next pageRendererDecorator](https://gunshi.dev/api/default/type-aliases/RendererDecorator)
