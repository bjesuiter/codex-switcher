[Skip to content](https://gunshi.dev/api/default/type-aliases/CommandCallMode#VPContent)
...
Are you an LLM? You can read better optimized documentation at /api/default/type-aliases/CommandCallMode.md for this page in Markdown format
[gunshi](https://gunshi.dev/api/) / [default](https://gunshi.dev/api/default/) / CommandCallMode
# Type Alias: CommandCallMode [​](https://gunshi.dev/api/default/type-aliases/CommandCallMode#type-alias-commandcallmode)
ts```
...
Pager
[Previous pageCommandable](https://gunshi.dev/api/default/type-aliases/Commandable)
[Next pageCommandContextCore](https://gunshi.dev/api/default/type-aliases/CommandContextCore)
