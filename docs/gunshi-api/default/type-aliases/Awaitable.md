[Skip to content](https://gunshi.dev/api/default/type-aliases/Awaitable#VPContent)
...
[gunshi](https://gunshi.dev/api/) / [default](https://gunshi.dev/api/default/) / Awaitable
# Type Alias: Awaitable<T> [​](https://gunshi.dev/api/default/type-aliases/Awaitable#type-alias-awaitable-t)
ts```
type Awaitable<T> = T | Promise<T>;
```

Awaitable type.
## Type Parameters [​](https://gunshi.dev/api/default/type-aliases/Awaitable#type-parameters)
Type Parameter | Description  
---|---  
`T` | The type of the value that can be awaited.  
Pager
[Previous pageArgValues](https://gunshi.dev/api/default/type-aliases/ArgValues)
[Next pageCommandable](https://gunshi.dev/api/default/type-aliases/Commandable)
