[Skip to content](https://gunshi.dev/api/default/type-aliases/CommandExamplesFetcher#VPContent)
...
On this page
  * [Type Parameters](https://gunshi.dev/api/default/type-aliases/CommandExamplesFetcher#type-parameters "Type Parameters")
  * [Parameters](https://gunshi.dev/api/default/type-aliases/CommandExamplesFetcher#parameters "Parameters")
  * [Returns](https://gunshi.dev/api/default/type-aliases/CommandExamplesFetcher#returns "Returns")


Are you an LLM? You can read better optimized documentation at /api/default/type-aliases/CommandExamplesFetcher.md for this page in Markdown format
[gunshi](https://gunshi.dev/api/) / [default](https://gunshi.dev/api/default/) / CommandExamplesFetcher
# Type Alias: CommandExamplesFetcher()<G> [​](https://gunshi.dev/api/default/type-aliases/CommandExamplesFetcher#type-alias-commandexamplesfetcher-g)
ts```
type CommandExamplesFetcher<G> = (ctx) => Awaitable<string>;
```

Command examples fetcher.
## Type Parameters [​](https://gunshi.dev/api/default/type-aliases/CommandExamplesFetcher#type-parameters)
...
## Parameters [​](https://gunshi.dev/api/default/type-aliases/CommandExamplesFetcher#parameters)
Parameter | Type | Description  
---|---|---  
`ctx` |  `Readonly`<[`CommandContext`](https://gunshi.dev/api/default/interfaces/CommandContext)<`G`>> | A [command context](https://gunshi.dev/api/default/interfaces/CommandContext)  
## Returns [​](https://gunshi.dev/api/default/type-aliases/CommandExamplesFetcher#returns)
[`Awaitable`](https://gunshi.dev/api/default/type-aliases/Awaitable)<`string`>
A fetched command examples.
Pager
[Previous pageCommandDecorator](https://gunshi.dev/api/default/type-aliases/CommandDecorator)
[Next pageCommandLoader](https://gunshi.dev/api/default/type-aliases/CommandLoader)
