[Skip to content](https://gunshi.dev/api/default/type-aliases/ValidationErrorsDecorator#VPContent)
...
On this page
  * [Type Parameters](https://gunshi.dev/api/default/type-aliases/ValidationErrorsDecorator#type-parameters "Type Parameters")
  * [Parameters](https://gunshi.dev/api/default/type-aliases/ValidationErrorsDecorator#parameters "Parameters")
  * [Returns](https://gunshi.dev/api/default/type-aliases/ValidationErrorsDecorator#returns "Returns")
  * [Since](https://gunshi.dev/api/default/type-aliases/ValidationErrorsDecorator#since "Since")


Are you an LLM? You can read better optimized documentation at /api/default/type-aliases/ValidationErrorsDecorator.md for this page in Markdown format
[gunshi](https://gunshi.dev/api/) / [default](https://gunshi.dev/api/default/) / ValidationErrorsDecorator
# Type Alias: ValidationErrorsDecorator()<G> [​](https://gunshi.dev/api/default/type-aliases/ValidationErrorsDecorator#type-alias-validationerrorsdecorator-g)
ts```
...
## Type Parameters [​](https://gunshi.dev/api/default/type-aliases/ValidationErrorsDecorator#type-parameters)
...
## Parameters [​](https://gunshi.dev/api/default/type-aliases/ValidationErrorsDecorator#parameters)
Parameter | Type | Description  
---|---|---  
`baseRenderer` | (`ctx`, `error`) => `Promise`<`string`> | The base validation errors renderer function to decorate  
`ctx` |  `Readonly`<[`CommandContext`](https://gunshi.dev/api/default/interfaces/CommandContext)<`G`>> | The command context  
`error` | `AggregateError` | The aggregate error containing validation errors  
## Returns [​](https://gunshi.dev/api/default/type-aliases/ValidationErrorsDecorator#returns)
`Promise`<`string`>
The decorated result
## Since [​](https://gunshi.dev/api/default/type-aliases/ValidationErrorsDecorator#since)
v0.27.0
Pager
[Previous pageRendererDecorator](https://gunshi.dev/api/default/type-aliases/RendererDecorator)
[Next pagedefinition](https://gunshi.dev/api/definition/)
