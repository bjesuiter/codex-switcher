[Skip to content](https://gunshi.dev/api/default/type-aliases/GunshiParamsConstraint#VPContent)
...
On this page
  * [Since](https://gunshi.dev/api/default/type-aliases/GunshiParamsConstraint#since "Since")


Are you an LLM? You can read better optimized documentation at /api/default/type-aliases/GunshiParamsConstraint.md for this page in Markdown format
[gunshi](https://gunshi.dev/api/) / [default](https://gunshi.dev/api/default/) / GunshiParamsConstraint
# Type Alias: GunshiParamsConstraint [​](https://gunshi.dev/api/default/type-aliases/GunshiParamsConstraint#type-alias-gunshiparamsconstraint)
ts```
...
This type constraint allows both [`GunshiParams`](https://gunshi.dev/api/default/interfaces/GunshiParams) and objects with extensions.
## Since [​](https://gunshi.dev/api/default/type-aliases/GunshiParamsConstraint#since)
v0.27.0
Pager
[Previous pageExtendContext](https://gunshi.dev/api/default/type-aliases/ExtendContext)
[Next pageLazyCommand](https://gunshi.dev/api/default/type-aliases/LazyCommand)
