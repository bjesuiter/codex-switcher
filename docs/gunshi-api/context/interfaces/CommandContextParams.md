[Skip to content](https://gunshi.dev/api/context/interfaces/CommandContextParams#VPContent)
...
On this page
  * [Type Parameters](https://gunshi.dev/api/context/interfaces/CommandContextParams#type-parameters "Type Parameters")
  * [Properties](https://gunshi.dev/api/context/interfaces/CommandContextParams#properties "Properties")


Are you an LLM? You can read better optimized documentation at /api/context/interfaces/CommandContextParams.md for this page in Markdown format
[gunshi](https://gunshi.dev/api/) / [context](https://gunshi.dev/api/context/) / CommandContextParams
# Interface: CommandContextParams<G, V, C, E> [​](https://gunshi.dev/api/context/interfaces/CommandContextParams#interface-commandcontextparams-g-v-c-e)
Parameters of [createCommandContext](https://gunshi.dev/api/context/functions/createCommandContext)
## Type Parameters [​](https://gunshi.dev/api/context/interfaces/CommandContextParams#type-parameters)
Type Parameter | Default type  
---|---  
`G` _extends_ | [`GunshiParams`](https://gunshi.dev/api/default/interfaces/GunshiParams) | { `args`: [`Args`](https://gunshi.dev/api/default/interfaces/Args); } | { `extensions`: [`ExtendContext`](https://gunshi.dev/api/default/type-aliases/ExtendContext); } | -  
`V` _extends_ [`ArgValues`](https://gunshi.dev/api/default/type-aliases/ArgValues)<`ExtractArgs`<`G`>> | -  
`C` _extends_ | [`Command`](https://gunshi.dev/api/default/interfaces/Command)<`G`> | [`LazyCommand`](https://gunshi.dev/api/default/type-aliases/LazyCommand)<`G`> |  [`Command`](https://gunshi.dev/api/default/interfaces/Command)<`G`>  
`E` _extends_ `Record`<`string`, [`CommandContextExtension`](https://gunshi.dev/api/default/interfaces/CommandContextExtension)> |  `Record`<`string`, [`CommandContextExtension`](https://gunshi.dev/api/default/interfaces/CommandContextExtension)>  
## Properties [​](https://gunshi.dev/api/context/interfaces/CommandContextParams#properties)
Property | Type | Description  
---|---|---  
`args?` |  `ExtractArgs`<`G`> | An arguments of target command  
`argv?` |  `string`[] | Original command line arguments  
`callMode?` | [`CommandCallMode`](https://gunshi.dev/api/default/type-aliases/CommandCallMode) | Command call mode.  
`cliOptions?` |  [`CliOptions`](https://gunshi.dev/api/default/interfaces/CliOptions)<`G`> | A command options, which is spicialized from `cli` function  
`command?` | `C` | A target command  
`commandPath?` |  `string`[] | The path of nested sub-commands resolved to reach the current command.  
...
`tokens?` |  [`ArgToken`](https://gunshi.dev/api/default/interfaces/ArgToken)[] | Argument tokens that are parsed by the `parseArgs` function  
`validationError?` | `AggregateError` | Validation error from argument parsing.  
`values?` | `V` | A values of target command  
Pager
[Previous pagecreateCommandContext](https://gunshi.dev/api/context/functions/createCommandContext)
[Next pagedefault](https://gunshi.dev/api/default/)
