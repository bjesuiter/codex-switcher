[Skip to content](https://gunshi.dev/api/context/functions/createCommandContext#VPContent)
...
On this page
  * [Type Parameters](https://gunshi.dev/api/context/functions/createCommandContext#type-parameters "Type Parameters")
  * [Parameters](https://gunshi.dev/api/context/functions/createCommandContext#parameters "Parameters")
  * [Returns](https://gunshi.dev/api/context/functions/createCommandContext#returns "Returns")


Are you an LLM? You can read better optimized documentation at /api/context/functions/createCommandContext.md for this page in Markdown format
[gunshi](https://gunshi.dev/api/) / [context](https://gunshi.dev/api/context/) / createCommandContext
# Function: createCommandContext() [​](https://gunshi.dev/api/context/functions/createCommandContext#function-createcommandcontext)
ts```
...
## Type Parameters [​](https://gunshi.dev/api/context/functions/createCommandContext#type-parameters)
...
`V` _extends_ `object` |  [`ArgValues`](https://gunshi.dev/api/default/type-aliases/ArgValues)<`ExtractArgs`<`G`>>  
...
`E` _extends_ `Record`<`string`, [`CommandContextExtension`](https://gunshi.dev/api/default/interfaces/CommandContextExtension)<{ }>> | `object`  
## Parameters [​](https://gunshi.dev/api/context/functions/createCommandContext#parameters)
Parameter | Type | Description  
---|---|---  
`param` |  [`CommandContextParams`](https://gunshi.dev/api/context/interfaces/CommandContextParams)<`G`, `V`, `C`, `E`> | A [parameters](https://gunshi.dev/api/context/interfaces/CommandContextParams) to create a command context.  
## Returns [​](https://gunshi.dev/api/context/functions/createCommandContext#returns)
`Promise`<`object` _extends_ `ExtractExtensions`<`E`> ? `Readonly`<[`CommandContext`](https://gunshi.dev/api/default/interfaces/CommandContext)<`G`>> : `Readonly`<[`CommandContext`](https://gunshi.dev/api/default/interfaces/CommandContext)<[`GunshiParams`](https://gunshi.dev/api/default/interfaces/GunshiParams)<{ `args`: `ExtractArgs`<`G`>; `extensions`: `ExtractExtensions`<`E`>; }>>>>
A [command context](https://gunshi.dev/api/default/interfaces/CommandContext), which is readonly.
Pager
[Previous pagecontext](https://gunshi.dev/api/context/)
[Next pageCommandContextParams](https://gunshi.dev/api/context/interfaces/CommandContextParams)
