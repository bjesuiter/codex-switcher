[Skip to content](https://gunshi.dev/api/renderer/#VPContent)
...
On this page
  * [Example](https://gunshi.dev/api/renderer/#example "Example")
  * [Functions](https://gunshi.dev/api/renderer/#functions "Functions")


Are you an LLM? You can read better optimized documentation at /api/renderer.md for this page in Markdown format
[gunshi](https://gunshi.dev/api/) / renderer
# renderer [​](https://gunshi.dev/api/renderer/#renderer)
The entry point for Gunshi renderer.
## Example [​](https://gunshi.dev/api/renderer/#example)
js```
import { renderHeader, renderUsage, renderValidationErrors } from 'gunshi/renderer'
```

## Functions [​](https://gunshi.dev/api/renderer/#functions)
Function | Description  
---|---  
[renderHeader](https://gunshi.dev/api/renderer/functions/renderHeader) | Render the header.  
[renderUsage](https://gunshi.dev/api/renderer/functions/renderUsage) | Render the usage.  
[renderValidationErrors](https://gunshi.dev/api/renderer/functions/renderValidationErrors) | Render the validation errors.  
Pager
[Previous pageCLI_OPTIONS_DEFAULT](https://gunshi.dev/api/plugin/variables/CLI_OPTIONS_DEFAULT)
[Next pagerenderHeader](https://gunshi.dev/api/renderer/functions/renderHeader)
