[Skip to content](https://gunshi.dev/api/definition/#VPContent)
...
On this page
  * [Example](https://gunshi.dev/api/definition/#example "Example")
  * [Functions](https://gunshi.dev/api/definition/#functions "Functions")
  * [References](https://gunshi.dev/api/definition/#references "References")


Are you an LLM? You can read better optimized documentation at /api/definition.md for this page in Markdown format
[gunshi](https://gunshi.dev/api/) / definition
# definition [​](https://gunshi.dev/api/definition/#definition)
...
## Example [​](https://gunshi.dev/api/definition/#example)
js```
...
## Functions [​](https://gunshi.dev/api/definition/#functions)
Function | Description  
---|---  
[define](https://gunshi.dev/api/definition/functions/define) | Define a [command](https://gunshi.dev/api/default/interfaces/Command).  
[defineWithTypes](https://gunshi.dev/api/definition/functions/defineWithTypes) | Define a [command](https://gunshi.dev/api/default/interfaces/Command) with types  
[lazy](https://gunshi.dev/api/definition/functions/lazy) | Define a [lazy command](https://gunshi.dev/api/default/type-aliases/LazyCommand) with or without definition.  
[lazyWithTypes](https://gunshi.dev/api/definition/functions/lazyWithTypes) | Define a [lazy command](https://gunshi.dev/api/default/type-aliases/LazyCommand) with specific type parameters.  
## References [​](https://gunshi.dev/api/definition/#references)
### Args [​](https://gunshi.dev/api/definition/#args)
Re-exports [Args](https://gunshi.dev/api/default/interfaces/Args)
* * *
### ArgSchema [​](https://gunshi.dev/api/definition/#argschema)
Re-exports [ArgSchema](https://gunshi.dev/api/default/interfaces/ArgSchema)
* * *
### ArgValues [​](https://gunshi.dev/api/definition/#argvalues)
Re-exports [ArgValues](https://gunshi.dev/api/default/type-aliases/ArgValues)
* * *
### Command [​](https://gunshi.dev/api/definition/#command)
Re-exports [Command](https://gunshi.dev/api/default/interfaces/Command)
* * *
### CommandContextParams [​](https://gunshi.dev/api/definition/#commandcontextparams)
Re-exports [CommandContextParams](https://gunshi.dev/api/context/interfaces/CommandContextParams)
* * *
### CommandLoader [​](https://gunshi.dev/api/definition/#commandloader)
Re-exports [CommandLoader](https://gunshi.dev/api/default/type-aliases/CommandLoader)
* * *
### CommandRunner [​](https://gunshi.dev/api/definition/#commandrunner)
Re-exports [CommandRunner](https://gunshi.dev/api/default/type-aliases/CommandRunner)
* * *
### createCommandContext [​](https://gunshi.dev/api/definition/#createcommandcontext)
Re-exports [createCommandContext](https://gunshi.dev/api/context/functions/createCommandContext)
* * *
### DefaultGunshiParams [​](https://gunshi.dev/api/definition/#defaultgunshiparams)
Re-exports [DefaultGunshiParams](https://gunshi.dev/api/default/type-aliases/DefaultGunshiParams)
* * *
### ExtendContext [​](https://gunshi.dev/api/definition/#extendcontext)
Re-exports [ExtendContext](https://gunshi.dev/api/default/type-aliases/ExtendContext)
* * *
### GunshiParams [​](https://gunshi.dev/api/definition/#gunshiparams)
Re-exports [GunshiParams](https://gunshi.dev/api/default/interfaces/GunshiParams)
* * *
### LazyCommand [​](https://gunshi.dev/api/definition/#lazycommand)
Re-exports [LazyCommand](https://gunshi.dev/api/default/type-aliases/LazyCommand)
Pager
[Previous pageValidationErrorsDecorator](https://gunshi.dev/api/default/type-aliases/ValidationErrorsDecorator)
[Next pagedefine](https://gunshi.dev/api/definition/functions/define)
