[Skip to content](https://gunshi.dev/api/renderer/functions/renderUsage#VPContent)
...
On this page
  * [Type Parameters](https://gunshi.dev/api/renderer/functions/renderUsage#type-parameters "Type Parameters")
  * [Parameters](https://gunshi.dev/api/renderer/functions/renderUsage#parameters "Parameters")
  * [Returns](https://gunshi.dev/api/renderer/functions/renderUsage#returns "Returns")


Are you an LLM? You can read better optimized documentation at /api/renderer/functions/renderUsage.md for this page in Markdown format
[gunshi](https://gunshi.dev/api/) / [renderer](https://gunshi.dev/api/renderer/) / renderUsage
# Function: renderUsage() [​](https://gunshi.dev/api/renderer/functions/renderUsage#function-renderusage)
ts```
function renderUsage<G>(ctx): Promise<string>;
```

Render the usage.
## Type Parameters [​](https://gunshi.dev/api/renderer/functions/renderUsage#type-parameters)
...
## Parameters [​](https://gunshi.dev/api/renderer/functions/renderUsage#parameters)
...
## Returns [​](https://gunshi.dev/api/renderer/functions/renderUsage#returns)
`Promise`<`string`>
A rendered usage.
Pager
[Previous pagerenderHeader](https://gunshi.dev/api/renderer/functions/renderHeader)
[Next pagerenderValidationErrors](https://gunshi.dev/api/renderer/functions/renderValidationErrors)
