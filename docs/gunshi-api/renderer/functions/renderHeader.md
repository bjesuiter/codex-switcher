[Skip to content](https://gunshi.dev/api/renderer/functions/renderHeader#VPContent)
...
Are you an LLM? You can read better optimized documentation at /api/renderer/functions/renderHeader.md for this page in Markdown format
[gunshi](https://gunshi.dev/api/) / [renderer](https://gunshi.dev/api/renderer/) / renderHeader
# Function: renderHeader() [​](https://gunshi.dev/api/renderer/functions/renderHeader#function-renderheader)
ts```
function renderHeader<G>(ctx): Promise<string>;
```

Render the header.
## Type Parameters [​](https://gunshi.dev/api/renderer/functions/renderHeader#type-parameters)
...
## Parameters [​](https://gunshi.dev/api/renderer/functions/renderHeader#parameters)
...
## Returns [​](https://gunshi.dev/api/renderer/functions/renderHeader#returns)
`Promise`<`string`>
A rendered header.
Pager
[Previous pagerenderer](https://gunshi.dev/api/renderer/)
[Next pagerenderUsage](https://gunshi.dev/api/renderer/functions/renderUsage)
