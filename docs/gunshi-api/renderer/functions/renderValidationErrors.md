[Skip to content](https://gunshi.dev/api/renderer/functions/renderValidationErrors#VPContent)
...
On this page
  * [Type Parameters](https://gunshi.dev/api/renderer/functions/renderValidationErrors#type-parameters "Type Parameters")
  * [Parameters](https://gunshi.dev/api/renderer/functions/renderValidationErrors#parameters "Parameters")
  * [Returns](https://gunshi.dev/api/renderer/functions/renderValidationErrors#returns "Returns")


Are you an LLM? You can read better optimized documentation at /api/renderer/functions/renderValidationErrors.md for this page in Markdown format
[gunshi](https://gunshi.dev/api/) / [renderer](https://gunshi.dev/api/renderer/) / renderValidationErrors
# Function: renderValidationErrors() [​](https://gunshi.dev/api/renderer/functions/renderValidationErrors#function-rendervalidationerrors)
ts```
function renderValidationErrors<G>(_ctx, error): Promise<string>;
```

Render the validation errors.
## Type Parameters [​](https://gunshi.dev/api/renderer/functions/renderValidationErrors#type-parameters)
Type Parameter | Default type  
---|---  
`G` _extends_ [`GunshiParams`](https://gunshi.dev/api/default/interfaces/GunshiParams)<{ `args`: [`Args`](https://gunshi.dev/api/default/interfaces/Args); `extensions`: { }; }> | [`DefaultGunshiParams`](https://gunshi.dev/api/default/type-aliases/DefaultGunshiParams)  
## Parameters [​](https://gunshi.dev/api/renderer/functions/renderValidationErrors#parameters)
Parameter | Type | Description  
---|---|---  
`_ctx` |  [`CommandContext`](https://gunshi.dev/api/default/interfaces/CommandContext)<`G`> | A [command context](https://gunshi.dev/api/default/interfaces/CommandContext)  
`error` | `AggregateError` | An AggregateError of option in `args-token` validation  
## Returns [​](https://gunshi.dev/api/renderer/functions/renderValidationErrors#returns)
`Promise`<`string`>
A rendered validation error.
Pager
[Previous pagerenderUsage](https://gunshi.dev/api/renderer/functions/renderUsage)
[Next pageShowcase](https://gunshi.dev/showcase)
