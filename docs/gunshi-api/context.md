[Skip to content](https://gunshi.dev/api/context/#VPContent)
...
On this page
  * [Example](https://gunshi.dev/api/context/#example "Example")
  * [Functions](https://gunshi.dev/api/context/#functions "Functions")
  * [Interfaces](https://gunshi.dev/api/context/#interfaces "Interfaces")


Are you an LLM? You can read better optimized documentation at /api/context.md for this page in Markdown format
[gunshi](https://gunshi.dev/api/) / context
# context [​](https://gunshi.dev/api/context/#context)
The entry for gunshi context. This module is exported for the purpose of testing the command.
## Example [​](https://gunshi.dev/api/context/#example)
js```
import { createCommandContext } from 'gunshi/context'
```

## Functions [​](https://gunshi.dev/api/context/#functions)
Function | Description  
---|---  
[createCommandContext](https://gunshi.dev/api/context/functions/createCommandContext) | Create a command context.  
## Interfaces [​](https://gunshi.dev/api/context/#interfaces)
Interface | Description  
---|---  
[CommandContextParams](https://gunshi.dev/api/context/interfaces/CommandContextParams) | Parameters of [createCommandContext](https://gunshi.dev/api/context/functions/createCommandContext)  
Pager
[Previous pageCombinatorSchema](https://gunshi.dev/api/combinators/type-aliases/CombinatorSchema)
[Next pagecreateCommandContext](https://gunshi.dev/api/context/functions/createCommandContext)
