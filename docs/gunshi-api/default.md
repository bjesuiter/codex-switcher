[Skip to content](https://gunshi.dev/api/default/#VPContent)
...
On this page
  * [Example](https://gunshi.dev/api/default/#example "Example")
  * [Variables](https://gunshi.dev/api/default/#variables "Variables")
  * [Functions](https://gunshi.dev/api/default/#functions "Functions")
  * [Classes](https://gunshi.dev/api/default/#classes "Classes")
  * [Interfaces](https://gunshi.dev/api/default/#interfaces "Interfaces")
  * [References](https://gunshi.dev/api/default/#references "References")
  * [Type Aliases](https://gunshi.dev/api/default/#type-aliases "Type Aliases")


Are you an LLM? You can read better optimized documentation at /api/default.md for this page in Markdown format
[gunshi](https://gunshi.dev/api/) / default
# default [​](https://gunshi.dev/api/default/#default)
...
## Example [​](https://gunshi.dev/api/default/#example)
js```
import { cli } from 'gunshi'
```

## Variables [​](https://gunshi.dev/api/default/#variables)
Variable | Description  
---|---  
[ANONYMOUS_COMMAND_NAME](https://gunshi.dev/api/default/variables/ANONYMOUS_COMMAND_NAME) | -  
## Functions [​](https://gunshi.dev/api/default/#functions)
Function | Description  
---|---  
[cli](https://gunshi.dev/api/default/functions/cli) | Run the command.  
[parseArgs](https://gunshi.dev/api/default/functions/parseArgs) | Parse command line arguments.  
[plugin](https://gunshi.dev/api/default/functions/plugin) | Define a plugin  
[resolveArgs](https://gunshi.dev/api/default/functions/resolveArgs) | Resolve command line arguments.  
## Classes [​](https://gunshi.dev/api/default/#classes)
Class | Description  
---|---  
[DefaultTranslation](https://gunshi.dev/api/default/classes/DefaultTranslation) | Default implementation of `TranslationAdapter`.  
## Interfaces [​](https://gunshi.dev/api/default/#interfaces)
Interface | Description  
---|---  
[Args](https://gunshi.dev/api/default/interfaces/Args) | An object that contains [argument schema](https://gunshi.dev/api/default/interfaces/ArgSchema).  
[ArgSchema](https://gunshi.dev/api/default/interfaces/ArgSchema) | An argument schema definition for command-line argument parsing.  
[ArgToken](https://gunshi.dev/api/default/interfaces/ArgToken) | Argument token.  
[CliOptions](https://gunshi.dev/api/default/interfaces/CliOptions) | CLI options of [`cli`](https://gunshi.dev/api/default/functions/cli) function.  
[Command](https://gunshi.dev/api/default/interfaces/Command) | Command interface.  
[CommandContext](https://gunshi.dev/api/default/interfaces/CommandContext) | Command context.  
[CommandContextExtension](https://gunshi.dev/api/default/interfaces/CommandContextExtension) | Command context extension  
[CommandEnvironment](https://gunshi.dev/api/default/interfaces/CommandEnvironment) | Command environment.  
[GunshiParams](https://gunshi.dev/api/default/interfaces/GunshiParams) | Gunshi unified parameter type.  
[PluginContext](https://gunshi.dev/api/default/interfaces/PluginContext) | Gunshi plugin context interface.  
[PluginDependency](https://gunshi.dev/api/default/interfaces/PluginDependency) | Plugin dependency definition  
[PluginOptions](https://gunshi.dev/api/default/interfaces/PluginOptions) | Plugin definition options  
[PluginWithExtension](https://gunshi.dev/api/default/interfaces/PluginWithExtension) | Plugin return type with extension, which includes the plugin ID, name, dependencies, and extension.  
[PluginWithoutExtension](https://gunshi.dev/api/default/interfaces/PluginWithoutExtension) | Plugin return type without extension, which includes the plugin ID, name, and dependencies, but no extension.  
[RenderingOptions](https://gunshi.dev/api/default/interfaces/RenderingOptions) | Rendering control options  
[SubCommandable](https://gunshi.dev/api/default/interfaces/SubCommandable) | Sub-command entry type for use in subCommands.  
## References [​](https://gunshi.dev/api/default/#references)
### CommandContextParams [​](https://gunshi.dev/api/default/#commandcontextparams)
Re-exports [CommandContextParams](https://gunshi.dev/api/context/interfaces/CommandContextParams)
* * *
### createCommandContext [​](https://gunshi.dev/api/default/#createcommandcontext)
Re-exports [createCommandContext](https://gunshi.dev/api/context/functions/createCommandContext)
* * *
### define [​](https://gunshi.dev/api/default/#define)
Re-exports [define](https://gunshi.dev/api/definition/functions/define)
* * *
### defineWithTypes [​](https://gunshi.dev/api/default/#definewithtypes)
Re-exports [defineWithTypes](https://gunshi.dev/api/definition/functions/defineWithTypes)
* * *
### lazy [​](https://gunshi.dev/api/default/#lazy)
Re-exports [lazy](https://gunshi.dev/api/definition/functions/lazy)
* * *
### lazyWithTypes [​](https://gunshi.dev/api/default/#lazywithtypes)
Re-exports [lazyWithTypes](https://gunshi.dev/api/definition/functions/lazyWithTypes)
## Type Aliases [​](https://gunshi.dev/api/default/#type-aliases)
Type Alias | Description  
---|---  
[ArgValues](https://gunshi.dev/api/default/type-aliases/ArgValues) | An object that contains the values of the arguments.  
[Awaitable](https://gunshi.dev/api/default/type-aliases/Awaitable) | Awaitable type.  
[Commandable](https://gunshi.dev/api/default/type-aliases/Commandable) | Define a command type.  
[CommandCallMode](https://gunshi.dev/api/default/type-aliases/CommandCallMode) | Command call mode.  
[CommandContextCore](https://gunshi.dev/api/default/type-aliases/CommandContextCore) | CommandContextCore type (base type without extensions)  
[CommandDecorator](https://gunshi.dev/api/default/type-aliases/CommandDecorator) | Command decorator.  
[CommandExamplesFetcher](https://gunshi.dev/api/default/type-aliases/CommandExamplesFetcher) | Command examples fetcher.  
[CommandLoader](https://gunshi.dev/api/default/type-aliases/CommandLoader) | Command loader.  
[CommandRunner](https://gunshi.dev/api/default/type-aliases/CommandRunner) | Command runner.  
[DefaultGunshiParams](https://gunshi.dev/api/default/type-aliases/DefaultGunshiParams) | Default Gunshi parameters.  
[ExtendContext](https://gunshi.dev/api/default/type-aliases/ExtendContext) | Extend command context type. This type is used to extend the command context with additional properties at [`CommandContext.extensions`](https://gunshi.dev/api/default/interfaces/CommandContext#extensions).  
[GunshiParamsConstraint](https://gunshi.dev/api/default/type-aliases/GunshiParamsConstraint) | Generic constraint for command-related types.  
[LazyCommand](https://gunshi.dev/api/default/type-aliases/LazyCommand) | Lazy command interface.  
[OnPluginExtension](https://gunshi.dev/api/default/type-aliases/OnPluginExtension) | Plugin extension callback, which is called when the plugin is extended with `extension` option.  
[Plugin](https://gunshi.dev/api/default/type-aliases/Plugin) | Gunshi plugin, which is a function that receives a PluginContext.  
[PluginExtension](https://gunshi.dev/api/default/type-aliases/PluginExtension) | Plugin extension  
[PluginFunction](https://gunshi.dev/api/default/type-aliases/PluginFunction) | Plugin function type  
[Prettify](https://gunshi.dev/api/default/type-aliases/Prettify) | Prettify a type by flattening its structure.  
[RendererDecorator](https://gunshi.dev/api/default/type-aliases/RendererDecorator) | Renderer decorator type.  
[ValidationErrorsDecorator](https://gunshi.dev/api/default/type-aliases/ValidationErrorsDecorator) | Validation errors renderer decorator type. A function that wraps a validation errors renderer to add or modify its behavior.  
Pager
[Previous pageCommandContextParams](https://gunshi.dev/api/context/interfaces/CommandContextParams)
[Next pageANONYMOUS_COMMAND_NAME](https://gunshi.dev/api/default/variables/ANONYMOUS_COMMAND_NAME)
